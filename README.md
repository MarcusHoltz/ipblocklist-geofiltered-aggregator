...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-410528-2D56A8)
...
**Last Updated:** 2025-11-18 03:30:58 UTC
...
- **Total Input IPs:** 410,528
- **Countries Processed:** 6
- **Combined Unique IPs:** 116,220
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 28.31%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 213,082 | 211,660 | 67,899 | 16.54% | `aggregated-us-only.txt` |
| Canada | CA | 17,510 | 17,389 | 8,997 | 2.19% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,226 | 33,096 | 8,412 | 2.05% | `aggregated-gb-only.txt` |
| Australia | AU | 11,247 | 11,177 | 4,696 | 1.14% | `aggregated-au-only.txt` |
| Germany | DE | 27,310 | 27,183 | 15,133 | 3.69% | `aggregated-de-only.txt` |
| South Korea | KR | 4,040 | 4,039 | 11,083 | 2.70% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 410,528 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,696 IPs from AU
- **`aggregated-ca-only.txt`** - 8,997 IPs from CA
- **`aggregated-de-only.txt`** - 15,133 IPs from DE
- **`aggregated-gb-only.txt`** - 8,412 IPs from GB
- **`aggregated-kr-only.txt`** - 11,083 IPs from KR
- **`aggregated-us-only.txt`** - 67,899 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 116,220 unique IPs (deduplicated across all countries)
