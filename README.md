...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-512007-2D56A8)
...
**Last Updated:** 2025-10-14 03:12:15 UTC
...
"United Kingdom" : 1.8
"Australia" : 0.8
"Other/Unfiltered" : 76.0
```

## Overall Summary

- **Total Input IPs:** 512,007
- **Countries Processed:** 6
- **Combined Unique IPs:** 122,951
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 24.01%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 227,690 | 225,148 | 69,517 | 13.58% | `aggregated-us-only.txt` |
| Canada | CA | 17,925 | 17,808 | 10,472 | 2.05% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,170 | 33,025 | 9,398 | 1.84% | `aggregated-gb-only.txt` |
| Australia | AU | 11,608 | 11,551 | 4,263 | 0.83% | `aggregated-au-only.txt` |
| Germany | DE | 27,833 | 27,710 | 16,845 | 3.29% | `aggregated-de-only.txt` |
| South Korea | KR | 4,022 | 4,021 | 12,456 | 2.43% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 512,007 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,263 IPs from AU
- **`aggregated-ca-only.txt`** - 10,472 IPs from CA
- **`aggregated-de-only.txt`** - 16,845 IPs from DE
- **`aggregated-gb-only.txt`** - 9,398 IPs from GB
- **`aggregated-kr-only.txt`** - 12,456 IPs from KR
- **`aggregated-us-only.txt`** - 69,517 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 122,951 unique IPs (deduplicated across all countries)
