...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-398741-2D56A8)
...
**Last Updated:** 2026-02-02 15:04:22 UTC
...
- **Total Input IPs:** 398,741
- **Countries Processed:** 6
- **Combined Unique IPs:** 120,107
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 190,220 | 188,593 | 73,248 | 18.37% | `aggregated-us-only.txt` |
| Canada | CA | 17,173 | 17,044 | 8,767 | 2.20% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,684 | 33,533 | 9,671 | 2.43% | `aggregated-gb-only.txt` |
| Australia | AU | 11,494 | 11,428 | 5,495 | 1.38% | `aggregated-au-only.txt` |
| Germany | DE | 27,778 | 27,657 | 15,079 | 3.78% | `aggregated-de-only.txt` |
| South Korea | KR | 4,017 | 4,003 | 7,847 | 1.97% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 398,741 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,495 IPs from AU
- **`aggregated-ca-only.txt`** - 8,767 IPs from CA
- **`aggregated-de-only.txt`** - 15,079 IPs from DE
- **`aggregated-gb-only.txt`** - 9,671 IPs from GB
- **`aggregated-kr-only.txt`** - 7,847 IPs from KR
- **`aggregated-us-only.txt`** - 73,248 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 120,107 unique IPs (deduplicated across all countries)
