...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-606751-2D56A8)
...
**Last Updated:** 2025-08-21 03:17:32 UTC
...
- **Total Input IPs:** 606,751
- **Countries Processed:** 6
- **Combined Unique IPs:** 131,515
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 21.68%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 217,567 | 216,153 | 73,985 | 12.19% | `aggregated-us-only.txt` |
| Canada | CA | 17,627 | 17,504 | 10,643 | 1.75% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,830 | 32,667 | 9,871 | 1.63% | `aggregated-gb-only.txt` |
| Australia | AU | 11,306 | 11,248 | 4,658 | 0.77% | `aggregated-au-only.txt` |
| Germany | DE | 27,147 | 27,041 | 19,112 | 3.15% | `aggregated-de-only.txt` |
| South Korea | KR | 3,944 | 3,931 | 13,246 | 2.18% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 606,751 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,658 IPs from AU
- **`aggregated-ca-only.txt`** - 10,643 IPs from CA
- **`aggregated-de-only.txt`** - 19,112 IPs from DE
- **`aggregated-gb-only.txt`** - 9,871 IPs from GB
- **`aggregated-kr-only.txt`** - 13,246 IPs from KR
- **`aggregated-us-only.txt`** - 73,985 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 131,515 unique IPs (deduplicated across all countries)
