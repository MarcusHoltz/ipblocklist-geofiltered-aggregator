...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-463518-2D56A8)
...
- **`aggregated.txt`** - 463,518 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,792 IPs from AU
- **`aggregated-ca-only.txt`** - 11,870 IPs from CA
- **`aggregated-de-only.txt`** - 18,915 IPs from DE
- **`aggregated-gb-only.txt`** - 11,317 IPs from GB
- **`aggregated-kr-only.txt`** - 8,574 IPs from KR
- **`aggregated-us-only.txt`** - 82,155 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 138,623 unique IPs (deduplicated across all countries)
