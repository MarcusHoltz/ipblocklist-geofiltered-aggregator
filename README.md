...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-521543-2D56A8)
...
**Last Updated:** 2025-10-13 03:19:43 UTC
...
- **Total Input IPs:** 521,543
- **Countries Processed:** 6
- **Combined Unique IPs:** 123,692
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.72%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 227,690 | 225,148 | 69,804 | 13.38% | `aggregated-us-only.txt` |
| Canada | CA | 17,925 | 17,808 | 10,543 | 2.02% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,170 | 33,025 | 9,448 | 1.81% | `aggregated-gb-only.txt` |
| Australia | AU | 11,608 | 11,551 | 4,313 | 0.83% | `aggregated-au-only.txt` |
| Germany | DE | 27,833 | 27,710 | 16,962 | 3.25% | `aggregated-de-only.txt` |
| South Korea | KR | 4,022 | 4,021 | 12,622 | 2.42% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 521,543 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,313 IPs from AU
- **`aggregated-ca-only.txt`** - 10,543 IPs from CA
- **`aggregated-de-only.txt`** - 16,962 IPs from DE
- **`aggregated-gb-only.txt`** - 9,448 IPs from GB
- **`aggregated-kr-only.txt`** - 12,622 IPs from KR
- **`aggregated-us-only.txt`** - 69,804 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,692 unique IPs (deduplicated across all countries)
