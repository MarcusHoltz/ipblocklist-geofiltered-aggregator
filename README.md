...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-272910-2D56A8)
...
**Last Updated:** 2026-08-17 14:49:24 UTC
...
"South Korea" : 1.3
"Australia" : 1.1
"Other/Unfiltered" : 72.4
```

## Overall Summary

- **Total Input IPs:** 272,910
- **Countries Processed:** 6
- **Combined Unique IPs:** 75,257
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 27.58%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 131,721 | 129,853 | 49,378 | 18.09% | `aggregated-us-only.txt` |
| Canada | CA | 17,158 | 17,035 | 5,946 | 2.18% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,713 | 35,551 | 5,429 | 1.99% | `aggregated-gb-only.txt` |
| Australia | AU | 12,195 | 12,123 | 2,907 | 1.07% | `aggregated-au-only.txt` |
| Germany | DE | 29,761 | 29,693 | 7,935 | 2.91% | `aggregated-de-only.txt` |
| South Korea | KR | 3,928 | 3,918 | 3,662 | 1.34% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 272,910 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 2,907 IPs from AU
- **`aggregated-ca-only.txt`** - 5,946 IPs from CA
- **`aggregated-de-only.txt`** - 7,935 IPs from DE
- **`aggregated-gb-only.txt`** - 5,429 IPs from GB
- **`aggregated-kr-only.txt`** - 3,662 IPs from KR
- **`aggregated-us-only.txt`** - 49,378 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 75,257 unique IPs (deduplicated across all countries)
