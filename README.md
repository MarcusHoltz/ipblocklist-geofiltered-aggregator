...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-544249-2D56A8)
...
**Last Updated:** 2025-10-05 14:31:35 UTC
...
"United Kingdom" : 1.7
"Australia" : 0.9
"Other/Unfiltered" : 76.1
```

## Overall Summary

- **Total Input IPs:** 544,249
- **Countries Processed:** 6
- **Combined Unique IPs:** 129,950
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.88%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 226,331 | 223,775 | 73,709 | 13.54% | `aggregated-us-only.txt` |
| Canada | CA | 17,971 | 17,851 | 11,159 | 2.05% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,071 | 32,917 | 9,512 | 1.75% | `aggregated-gb-only.txt` |
| Australia | AU | 11,560 | 11,500 | 4,686 | 0.86% | `aggregated-au-only.txt` |
| Germany | DE | 27,643 | 27,520 | 18,022 | 3.31% | `aggregated-de-only.txt` |
| South Korea | KR | 4,001 | 4,000 | 12,862 | 2.36% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 544,249 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,686 IPs from AU
- **`aggregated-ca-only.txt`** - 11,159 IPs from CA
- **`aggregated-de-only.txt`** - 18,022 IPs from DE
- **`aggregated-gb-only.txt`** - 9,512 IPs from GB
- **`aggregated-kr-only.txt`** - 12,862 IPs from KR
- **`aggregated-us-only.txt`** - 73,709 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,950 unique IPs (deduplicated across all countries)
