...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-437943-2D56A8)
...
**Last Updated:** 2026-07-23 05:36:55 UTC
...
- **Total Input IPs:** 437,943
- **Countries Processed:** 6
- **Combined Unique IPs:** 128,712
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 137,787 | 135,973 | 77,629 | 17.73% | `aggregated-us-only.txt` |
| Canada | CA | 16,857 | 16,741 | 8,413 | 1.92% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,446 | 35,279 | 9,882 | 2.26% | `aggregated-gb-only.txt` |
| Australia | AU | 12,109 | 12,038 | 6,697 | 1.53% | `aggregated-au-only.txt` |
| Germany | DE | 29,153 | 29,083 | 19,683 | 4.49% | `aggregated-de-only.txt` |
| South Korea | KR | 3,909 | 3,899 | 6,408 | 1.46% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 437,943 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 6,697 IPs from AU
- **`aggregated-ca-only.txt`** - 8,413 IPs from CA
- **`aggregated-de-only.txt`** - 19,683 IPs from DE
- **`aggregated-gb-only.txt`** - 9,882 IPs from GB
- **`aggregated-kr-only.txt`** - 6,408 IPs from KR
- **`aggregated-us-only.txt`** - 77,629 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 128,712 unique IPs (deduplicated across all countries)
