...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-466080-2D56A8)
...
**Last Updated:** 2026-08-18 03:12:16 UTC
...
- **Total Input IPs:** 466,080
- **Countries Processed:** 6
- **Combined Unique IPs:** 130,476
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 131,721 | 129,853 | 86,646 | 18.59% | `aggregated-us-only.txt` |
| Canada | CA | 17,158 | 17,035 | 8,919 | 1.91% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,713 | 35,551 | 8,923 | 1.91% | `aggregated-gb-only.txt` |
| Australia | AU | 12,195 | 12,123 | 4,073 | 0.87% | `aggregated-au-only.txt` |
| Germany | DE | 29,761 | 29,693 | 15,520 | 3.33% | `aggregated-de-only.txt` |
| South Korea | KR | 3,928 | 3,918 | 6,395 | 1.37% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 466,080 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,073 IPs from AU
- **`aggregated-ca-only.txt`** - 8,919 IPs from CA
- **`aggregated-de-only.txt`** - 15,520 IPs from DE
- **`aggregated-gb-only.txt`** - 8,923 IPs from GB
- **`aggregated-kr-only.txt`** - 6,395 IPs from KR
- **`aggregated-us-only.txt`** - 86,646 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 130,476 unique IPs (deduplicated across all countries)
