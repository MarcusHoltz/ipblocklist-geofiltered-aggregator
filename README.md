...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-431847-2D56A8)
...
**Last Updated:** 2026-07-02 06:13:02 UTC
...
- **Total Input IPs:** 431,847
- **Countries Processed:** 6
- **Combined Unique IPs:** 142,246
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 149,937 | 148,118 | 79,092 | 18.31% | `aggregated-us-only.txt` |
| Canada | CA | 16,781 | 16,649 | 10,309 | 2.39% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,005 | 34,838 | 14,654 | 3.39% | `aggregated-gb-only.txt` |
| Australia | AU | 12,035 | 11,960 | 10,501 | 2.43% | `aggregated-au-only.txt` |
| Germany | DE | 28,921 | 28,848 | 21,420 | 4.96% | `aggregated-de-only.txt` |
| South Korea | KR | 3,914 | 3,904 | 6,270 | 1.45% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 431,847 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,501 IPs from AU
- **`aggregated-ca-only.txt`** - 10,309 IPs from CA
- **`aggregated-de-only.txt`** - 21,420 IPs from DE
- **`aggregated-gb-only.txt`** - 14,654 IPs from GB
- **`aggregated-kr-only.txt`** - 6,270 IPs from KR
- **`aggregated-us-only.txt`** - 79,092 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 142,246 unique IPs (deduplicated across all countries)
