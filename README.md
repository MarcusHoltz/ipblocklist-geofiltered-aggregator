...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-378840-2D56A8)
...
- **`aggregated.txt`** - 378,840 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 7,090 IPs from AU
- **`aggregated-ca-only.txt`** - 8,693 IPs from CA
- **`aggregated-de-only.txt`** - 16,067 IPs from DE
- **`aggregated-gb-only.txt`** - 9,760 IPs from GB
- **`aggregated-kr-only.txt`** - 6,789 IPs from KR
- **`aggregated-us-only.txt`** - 73,154 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,553 unique IPs (deduplicated across all countries)
