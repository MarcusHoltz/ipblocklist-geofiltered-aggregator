...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-509996-2D56A8)
...
**Last Updated:** 2025-10-16 03:14:28 UTC
...
"United Kingdom" : 1.9
"Australia" : 0.8
"Other/Unfiltered" : 75.8
```

## Overall Summary

- **Total Input IPs:** 509,996
- **Countries Processed:** 6
- **Combined Unique IPs:** 123,263
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 24.17%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 227,690 | 225,148 | 69,958 | 13.72% | `aggregated-us-only.txt` |
| Canada | CA | 17,925 | 17,808 | 10,414 | 2.04% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,170 | 33,025 | 9,452 | 1.85% | `aggregated-gb-only.txt` |
| Australia | AU | 11,608 | 11,551 | 4,276 | 0.84% | `aggregated-au-only.txt` |
| Germany | DE | 27,833 | 27,710 | 16,806 | 3.30% | `aggregated-de-only.txt` |
| South Korea | KR | 4,022 | 4,021 | 12,357 | 2.42% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 509,996 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,276 IPs from AU
- **`aggregated-ca-only.txt`** - 10,414 IPs from CA
- **`aggregated-de-only.txt`** - 16,806 IPs from DE
- **`aggregated-gb-only.txt`** - 9,452 IPs from GB
- **`aggregated-kr-only.txt`** - 12,357 IPs from KR
- **`aggregated-us-only.txt`** - 69,958 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,263 unique IPs (deduplicated across all countries)
