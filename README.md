...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-442498-2D56A8)
...
**Last Updated:** 2026-07-12 05:41:13 UTC
...
- **Total Input IPs:** 442,498
- **Countries Processed:** 6
- **Combined Unique IPs:** 137,868
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 141,446 | 139,632 | 78,602 | 17.76% | `aggregated-us-only.txt` |
| Canada | CA | 16,872 | 16,752 | 9,466 | 2.14% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,500 | 35,331 | 12,903 | 2.92% | `aggregated-gb-only.txt` |
| Australia | AU | 12,038 | 11,968 | 9,481 | 2.14% | `aggregated-au-only.txt` |
| Germany | DE | 29,072 | 29,000 | 21,132 | 4.78% | `aggregated-de-only.txt` |
| South Korea | KR | 3,887 | 3,877 | 6,284 | 1.42% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 442,498 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 9,481 IPs from AU
- **`aggregated-ca-only.txt`** - 9,466 IPs from CA
- **`aggregated-de-only.txt`** - 21,132 IPs from DE
- **`aggregated-gb-only.txt`** - 12,903 IPs from GB
- **`aggregated-kr-only.txt`** - 6,284 IPs from KR
- **`aggregated-us-only.txt`** - 78,602 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 137,868 unique IPs (deduplicated across all countries)
