...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-472928-2D56A8)
...
**Last Updated:** 2026-08-31 08:43:59 UTC
...
- **Total Input IPs:** 472,928
- **Countries Processed:** 6
- **Combined Unique IPs:** 138,091
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,784 | 128,927 | 96,397 | 20.38% | `aggregated-us-only.txt` |
| Canada | CA | 17,155 | 17,039 | 8,431 | 1.78% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,780 | 35,619 | 8,731 | 1.85% | `aggregated-gb-only.txt` |
| Australia | AU | 12,241 | 12,174 | 3,587 | 0.76% | `aggregated-au-only.txt` |
| Germany | DE | 29,886 | 29,769 | 14,710 | 3.11% | `aggregated-de-only.txt` |
| South Korea | KR | 3,921 | 3,910 | 6,235 | 1.32% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 472,928 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,587 IPs from AU
- **`aggregated-ca-only.txt`** - 8,431 IPs from CA
- **`aggregated-de-only.txt`** - 14,710 IPs from DE
- **`aggregated-gb-only.txt`** - 8,731 IPs from GB
- **`aggregated-kr-only.txt`** - 6,235 IPs from KR
- **`aggregated-us-only.txt`** - 96,397 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 138,091 unique IPs (deduplicated across all countries)
