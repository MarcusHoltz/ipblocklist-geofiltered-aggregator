...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-424767-2D56A8)
...
**Last Updated:** 2025-12-18 14:43:56 UTC
...
- **Total Input IPs:** 424,767
- **Countries Processed:** 6
- **Combined Unique IPs:** 125,597
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 205,029 | 203,447 | 74,899 | 17.63% | `aggregated-us-only.txt` |
| Canada | CA | 17,534 | 17,408 | 8,545 | 2.01% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,613 | 33,458 | 9,896 | 2.33% | `aggregated-gb-only.txt` |
| Australia | AU | 11,630 | 11,560 | 5,603 | 1.32% | `aggregated-au-only.txt` |
| Germany | DE | 27,435 | 27,295 | 15,973 | 3.76% | `aggregated-de-only.txt` |
| South Korea | KR | 3,986 | 3,985 | 10,681 | 2.51% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 424,767 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,603 IPs from AU
- **`aggregated-ca-only.txt`** - 8,545 IPs from CA
- **`aggregated-de-only.txt`** - 15,973 IPs from DE
- **`aggregated-gb-only.txt`** - 9,896 IPs from GB
- **`aggregated-kr-only.txt`** - 10,681 IPs from KR
- **`aggregated-us-only.txt`** - 74,899 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 125,597 unique IPs (deduplicated across all countries)
