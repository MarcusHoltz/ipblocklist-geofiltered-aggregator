...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-572563-2D56A8)
...
**Last Updated:** 2025-09-25 14:40:03 UTC
...
- **Total Input IPs:** 572,563
- **Countries Processed:** 6
- **Combined Unique IPs:** 133,355
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 224,791 | 222,401 | 74,570 | 13.02% | `aggregated-us-only.txt` |
| Canada | CA | 17,886 | 17,771 | 11,423 | 2.00% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,808 | 32,653 | 9,617 | 1.68% | `aggregated-gb-only.txt` |
| Australia | AU | 11,669 | 11,610 | 4,823 | 0.84% | `aggregated-au-only.txt` |
| Germany | DE | 27,582 | 27,471 | 19,514 | 3.41% | `aggregated-de-only.txt` |
| South Korea | KR | 4,009 | 4,008 | 13,408 | 2.34% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 572,563 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,823 IPs from AU
- **`aggregated-ca-only.txt`** - 11,423 IPs from CA
- **`aggregated-de-only.txt`** - 19,514 IPs from DE
- **`aggregated-gb-only.txt`** - 9,617 IPs from GB
- **`aggregated-kr-only.txt`** - 13,408 IPs from KR
- **`aggregated-us-only.txt`** - 74,570 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 133,355 unique IPs (deduplicated across all countries)
