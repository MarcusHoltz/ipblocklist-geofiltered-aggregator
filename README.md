...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-425217-2D56A8)
...
**Last Updated:** 2026-03-23 15:18:11 UTC
...
- **Total Input IPs:** 425,217
- **Countries Processed:** 6
- **Combined Unique IPs:** 137,243
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 32.28%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 181,809 | 180,208 | 77,065 | 18.12% | `aggregated-us-only.txt` |
| Canada | CA | 16,866 | 16,741 | 9,386 | 2.21% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,693 | 33,508 | 14,468 | 3.40% | `aggregated-gb-only.txt` |
| Australia | AU | 11,441 | 11,360 | 10,745 | 2.53% | `aggregated-au-only.txt` |
| Germany | DE | 28,381 | 28,291 | 19,030 | 4.48% | `aggregated-de-only.txt` |
| South Korea | KR | 4,031 | 4,020 | 6,549 | 1.54% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 425,217 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,745 IPs from AU
- **`aggregated-ca-only.txt`** - 9,386 IPs from CA
- **`aggregated-de-only.txt`** - 19,030 IPs from DE
- **`aggregated-gb-only.txt`** - 14,468 IPs from GB
- **`aggregated-kr-only.txt`** - 6,549 IPs from KR
- **`aggregated-us-only.txt`** - 77,065 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 137,243 unique IPs (deduplicated across all countries)
