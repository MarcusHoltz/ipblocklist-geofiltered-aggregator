...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-513647-2D56A8)
...
**Last Updated:** 2025-10-14 14:40:10 UTC
...
- **Total Input IPs:** 513,647
- **Countries Processed:** 6
- **Combined Unique IPs:** 123,712
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 24.09%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 227,690 | 225,148 | 69,929 | 13.61% | `aggregated-us-only.txt` |
| Canada | CA | 17,925 | 17,808 | 10,539 | 2.05% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,170 | 33,025 | 9,493 | 1.85% | `aggregated-gb-only.txt` |
| Australia | AU | 11,608 | 11,551 | 4,274 | 0.83% | `aggregated-au-only.txt` |
| Germany | DE | 27,833 | 27,710 | 17,021 | 3.31% | `aggregated-de-only.txt` |
...
- **`aggregated.txt`** - 513,647 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,274 IPs from AU
- **`aggregated-ca-only.txt`** - 10,539 IPs from CA
- **`aggregated-de-only.txt`** - 17,021 IPs from DE
- **`aggregated-gb-only.txt`** - 9,493 IPs from GB
- **`aggregated-kr-only.txt`** - 12,456 IPs from KR
- **`aggregated-us-only.txt`** - 69,929 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,712 unique IPs (deduplicated across all countries)
