...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-374314-2D56A8)
...
**Last Updated:** 2026-02-23 04:35:11 UTC
...
- **Total Input IPs:** 374,314
- **Countries Processed:** 6
- **Combined Unique IPs:** 117,976
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 31.52%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 187,140 | 185,523 | 72,131 | 19.27% | `aggregated-us-only.txt` |
| Canada | CA | 16,884 | 16,753 | 8,297 | 2.22% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,109 | 32,941 | 8,995 | 2.40% | `aggregated-gb-only.txt` |
| Australia | AU | 11,405 | 11,339 | 6,348 | 1.70% | `aggregated-au-only.txt` |
| Germany | DE | 28,130 | 28,030 | 15,415 | 4.12% | `aggregated-de-only.txt` |
| South Korea | KR | 4,020 | 4,019 | 6,790 | 1.81% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 374,314 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 6,348 IPs from AU
- **`aggregated-ca-only.txt`** - 8,297 IPs from CA
- **`aggregated-de-only.txt`** - 15,415 IPs from DE
- **`aggregated-gb-only.txt`** - 8,995 IPs from GB
- **`aggregated-kr-only.txt`** - 6,790 IPs from KR
- **`aggregated-us-only.txt`** - 72,131 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 117,976 unique IPs (deduplicated across all countries)
