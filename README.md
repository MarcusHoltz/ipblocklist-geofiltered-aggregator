...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-432755-2D56A8)
...
**Last Updated:** 2025-12-30 14:42:38 UTC
...
- **Total Input IPs:** 432,755
- **Countries Processed:** 6
- **Combined Unique IPs:** 130,646
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 199,419 | 197,811 | 77,113 | 17.82% | `aggregated-us-only.txt` |
| Canada | CA | 17,248 | 17,118 | 9,074 | 2.10% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,774 | 33,608 | 9,740 | 2.25% | `aggregated-gb-only.txt` |
| Australia | AU | 11,596 | 11,526 | 5,767 | 1.33% | `aggregated-au-only.txt` |
| Germany | DE | 27,528 | 27,389 | 18,410 | 4.25% | `aggregated-de-only.txt` |
| South Korea | KR | 3,990 | 3,989 | 10,542 | 2.44% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 432,755 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,767 IPs from AU
- **`aggregated-ca-only.txt`** - 9,074 IPs from CA
- **`aggregated-de-only.txt`** - 18,410 IPs from DE
- **`aggregated-gb-only.txt`** - 9,740 IPs from GB
- **`aggregated-kr-only.txt`** - 10,542 IPs from KR
- **`aggregated-us-only.txt`** - 77,113 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 130,646 unique IPs (deduplicated across all countries)
