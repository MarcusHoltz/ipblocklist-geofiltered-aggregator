...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-521481-2D56A8)
...
**Last Updated:** 2025-10-07 03:08:59 UTC
...
- **Total Input IPs:** 521,481
- **Countries Processed:** 6
- **Combined Unique IPs:** 122,456
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.48%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 226,331 | 223,775 | 68,991 | 13.23% | `aggregated-us-only.txt` |
| Canada | CA | 17,971 | 17,851 | 10,524 | 2.02% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,071 | 32,917 | 9,212 | 1.77% | `aggregated-gb-only.txt` |
| Australia | AU | 11,560 | 11,500 | 4,144 | 0.79% | `aggregated-au-only.txt` |
| Germany | DE | 27,643 | 27,520 | 16,847 | 3.23% | `aggregated-de-only.txt` |
| South Korea | KR | 4,001 | 4,000 | 12,738 | 2.44% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 521,481 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,144 IPs from AU
- **`aggregated-ca-only.txt`** - 10,524 IPs from CA
- **`aggregated-de-only.txt`** - 16,847 IPs from DE
- **`aggregated-gb-only.txt`** - 9,212 IPs from GB
- **`aggregated-kr-only.txt`** - 12,738 IPs from KR
- **`aggregated-us-only.txt`** - 68,991 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 122,456 unique IPs (deduplicated across all countries)
