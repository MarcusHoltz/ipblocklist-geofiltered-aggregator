...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-442381-2D56A8)
...
- **`aggregated.txt`** - 442,381 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,367 IPs from AU
- **`aggregated-ca-only.txt`** - 9,426 IPs from CA
- **`aggregated-de-only.txt`** - 15,751 IPs from DE
- **`aggregated-gb-only.txt`** - 9,141 IPs from GB
- **`aggregated-kr-only.txt`** - 11,717 IPs from KR
- **`aggregated-us-only.txt`** - 69,098 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 119,500 unique IPs (deduplicated across all countries)
