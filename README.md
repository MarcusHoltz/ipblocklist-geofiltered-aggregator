...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-399793-2D56A8)
...
**Last Updated:** 2025-12-06 03:28:32 UTC
...
- **Total Input IPs:** 399,793
- **Countries Processed:** 6
- **Combined Unique IPs:** 121,270
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 208,627 | 207,128 | 72,177 | 18.05% | `aggregated-us-only.txt` |
| Canada | CA | 17,397 | 17,271 | 8,502 | 2.13% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,084 | 32,951 | 9,007 | 2.25% | `aggregated-gb-only.txt` |
| Australia | AU | 11,257 | 11,196 | 5,420 | 1.36% | `aggregated-au-only.txt` |
| Germany | DE | 27,412 | 27,288 | 14,999 | 3.75% | `aggregated-de-only.txt` |
| South Korea | KR | 4,016 | 4,015 | 11,165 | 2.79% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 399,793 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,420 IPs from AU
- **`aggregated-ca-only.txt`** - 8,502 IPs from CA
- **`aggregated-de-only.txt`** - 14,999 IPs from DE
- **`aggregated-gb-only.txt`** - 9,007 IPs from GB
- **`aggregated-kr-only.txt`** - 11,165 IPs from KR
- **`aggregated-us-only.txt`** - 72,177 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,270 unique IPs (deduplicated across all countries)
