...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-475418-2D56A8)
...
**Last Updated:** 2026-09-05 16:52:56 UTC
...
- **Total Input IPs:** 475,418
- **Countries Processed:** 6
- **Combined Unique IPs:** 140,016
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,784 | 128,927 | 98,975 | 20.82% | `aggregated-us-only.txt` |
| Canada | CA | 17,155 | 17,039 | 7,800 | 1.64% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,780 | 35,619 | 8,648 | 1.82% | `aggregated-gb-only.txt` |
| Australia | AU | 12,241 | 12,174 | 3,613 | 0.76% | `aggregated-au-only.txt` |
| Germany | DE | 29,886 | 29,769 | 14,684 | 3.09% | `aggregated-de-only.txt` |
| South Korea | KR | 3,921 | 3,910 | 6,296 | 1.32% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 475,418 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,613 IPs from AU
- **`aggregated-ca-only.txt`** - 7,800 IPs from CA
- **`aggregated-de-only.txt`** - 14,684 IPs from DE
- **`aggregated-gb-only.txt`** - 8,648 IPs from GB
- **`aggregated-kr-only.txt`** - 6,296 IPs from KR
- **`aggregated-us-only.txt`** - 98,975 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 140,016 unique IPs (deduplicated across all countries)
