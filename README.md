...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-463174-2D56A8)
...
- **`aggregated.txt`** - 463,174 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,822 IPs from AU
- **`aggregated-ca-only.txt`** - 11,705 IPs from CA
- **`aggregated-de-only.txt`** - 18,286 IPs from DE
- **`aggregated-gb-only.txt`** - 11,560 IPs from GB
- **`aggregated-kr-only.txt`** - 8,587 IPs from KR
- **`aggregated-us-only.txt`** - 82,283 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 138,243 unique IPs (deduplicated across all countries)
