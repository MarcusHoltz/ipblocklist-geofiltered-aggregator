...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-721524-2D56A8)
...
- **`aggregated.txt`** - 721,524 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,216 IPs from AU
- **`aggregated-ca-only.txt`** - 11,770 IPs from CA
- **`aggregated-de-only.txt`** - 22,028 IPs from DE
- **`aggregated-gb-only.txt`** - 13,959 IPs from GB
- **`aggregated-kr-only.txt`** - 10,512 IPs from KR
- **`aggregated-us-only.txt`** - 150,092 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 213,577 unique IPs (deduplicated across all countries)
