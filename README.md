...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-559668-2D56A8)
...
**Last Updated:** 2026-01-08 03:49:02 UTC
...
- **Total Input IPs:** 559,668
- **Countries Processed:** 6
- **Combined Unique IPs:** 184,144
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 32.90%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 196,770 | 195,158 | 117,253 | 20.95% | `aggregated-us-only.txt` |
| Canada | CA | 17,228 | 17,102 | 12,353 | 2.21% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,886 | 33,721 | 12,704 | 2.27% | `aggregated-gb-only.txt` |
| Australia | AU | 11,593 | 11,526 | 5,893 | 1.05% | `aggregated-au-only.txt` |
| Germany | DE | 27,570 | 27,431 | 21,736 | 3.88% | `aggregated-de-only.txt` |
| South Korea | KR | 3,983 | 3,982 | 14,205 | 2.54% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 559,668 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,893 IPs from AU
- **`aggregated-ca-only.txt`** - 12,353 IPs from CA
- **`aggregated-de-only.txt`** - 21,736 IPs from DE
- **`aggregated-gb-only.txt`** - 12,704 IPs from GB
- **`aggregated-kr-only.txt`** - 14,205 IPs from KR
- **`aggregated-us-only.txt`** - 117,253 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 184,144 unique IPs (deduplicated across all countries)
