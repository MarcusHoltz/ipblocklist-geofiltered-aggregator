...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-507224-2D56A8)
...
**Last Updated:** 2025-10-18 14:32:31 UTC
...
- **Total Input IPs:** 507,224
- **Countries Processed:** 6
- **Combined Unique IPs:** 123,746
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 24.40%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 227,690 | 225,148 | 70,353 | 13.87% | `aggregated-us-only.txt` |
| Canada | CA | 17,925 | 17,808 | 10,418 | 2.05% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,170 | 33,025 | 9,503 | 1.87% | `aggregated-gb-only.txt` |
| Australia | AU | 11,608 | 11,551 | 4,251 | 0.84% | `aggregated-au-only.txt` |
| Germany | DE | 27,833 | 27,710 | 16,836 | 3.32% | `aggregated-de-only.txt` |
| South Korea | KR | 4,022 | 4,021 | 12,385 | 2.44% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 507,224 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,251 IPs from AU
- **`aggregated-ca-only.txt`** - 10,418 IPs from CA
- **`aggregated-de-only.txt`** - 16,836 IPs from DE
- **`aggregated-gb-only.txt`** - 9,503 IPs from GB
- **`aggregated-kr-only.txt`** - 12,385 IPs from KR
- **`aggregated-us-only.txt`** - 70,353 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,746 unique IPs (deduplicated across all countries)
