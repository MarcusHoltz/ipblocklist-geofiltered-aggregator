...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-602488-2D56A8)
...
**Last Updated:** 2025-08-29 14:36:30 UTC
...
- **Total Input IPs:** 602,488
- **Countries Processed:** 6
- **Combined Unique IPs:** 133,278
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 218,244 | 216,816 | 75,278 | 12.49% | `aggregated-us-only.txt` |
| Canada | CA | 17,804 | 17,678 | 10,998 | 1.83% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,316 | 32,142 | 9,738 | 1.62% | `aggregated-gb-only.txt` |
| Australia | AU | 11,315 | 11,257 | 4,627 | 0.77% | `aggregated-au-only.txt` |
| Germany | DE | 27,285 | 27,176 | 19,370 | 3.22% | `aggregated-de-only.txt` |
| South Korea | KR | 3,946 | 3,933 | 13,267 | 2.20% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 602,488 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,627 IPs from AU
- **`aggregated-ca-only.txt`** - 10,998 IPs from CA
- **`aggregated-de-only.txt`** - 19,370 IPs from DE
- **`aggregated-gb-only.txt`** - 9,738 IPs from GB
- **`aggregated-kr-only.txt`** - 13,267 IPs from KR
- **`aggregated-us-only.txt`** - 75,278 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 133,278 unique IPs (deduplicated across all countries)
