...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-428715-2D56A8)
...
**Last Updated:** 2026-06-14 07:00:30 UTC
...
"Canada" : 2.5
"South Korea" : 1.3
"Other/Unfiltered" : 65.2
```

## Overall Summary

- **Total Input IPs:** 428,715
- **Countries Processed:** 6
- **Combined Unique IPs:** 149,076
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 34.77%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 162,102 | 160,287 | 81,912 | 19.11% | `aggregated-us-only.txt` |
| Canada | CA | 16,986 | 16,858 | 10,826 | 2.53% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,600 | 35,425 | 15,965 | 3.72% | `aggregated-gb-only.txt` |
| Australia | AU | 12,043 | 11,960 | 10,932 | 2.55% | `aggregated-au-only.txt` |
| Germany | DE | 28,808 | 28,728 | 23,747 | 5.54% | `aggregated-de-only.txt` |
| South Korea | KR | 3,954 | 3,944 | 5,694 | 1.33% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 428,715 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,932 IPs from AU
- **`aggregated-ca-only.txt`** - 10,826 IPs from CA
- **`aggregated-de-only.txt`** - 23,747 IPs from DE
- **`aggregated-gb-only.txt`** - 15,965 IPs from GB
- **`aggregated-kr-only.txt`** - 5,694 IPs from KR
- **`aggregated-us-only.txt`** - 81,912 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 149,076 unique IPs (deduplicated across all countries)
