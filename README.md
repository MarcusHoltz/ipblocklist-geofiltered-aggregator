...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-414075-2D56A8)
...
**Last Updated:** 2025-11-17 14:41:29 UTC
...
- **Total Input IPs:** 414,075
- **Countries Processed:** 6
- **Combined Unique IPs:** 116,958
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 213,082 | 211,660 | 68,337 | 16.50% | `aggregated-us-only.txt` |
| Canada | CA | 17,510 | 17,389 | 9,106 | 2.20% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,226 | 33,096 | 8,479 | 2.05% | `aggregated-gb-only.txt` |
| Australia | AU | 11,247 | 11,177 | 4,688 | 1.13% | `aggregated-au-only.txt` |
| Germany | DE | 27,310 | 27,183 | 15,183 | 3.67% | `aggregated-de-only.txt` |
| South Korea | KR | 4,040 | 4,039 | 11,165 | 2.70% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 414,075 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,688 IPs from AU
- **`aggregated-ca-only.txt`** - 9,106 IPs from CA
- **`aggregated-de-only.txt`** - 15,183 IPs from DE
- **`aggregated-gb-only.txt`** - 8,479 IPs from GB
- **`aggregated-kr-only.txt`** - 11,165 IPs from KR
- **`aggregated-us-only.txt`** - 68,337 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 116,958 unique IPs (deduplicated across all countries)
