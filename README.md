...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-603470-2D56A8)
...
- **`aggregated.txt`** - 603,470 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,488 IPs from AU
- **`aggregated-ca-only.txt`** - 10,531 IPs from CA
- **`aggregated-de-only.txt`** - 19,307 IPs from DE
- **`aggregated-gb-only.txt`** - 9,601 IPs from GB
- **`aggregated-kr-only.txt`** - 13,251 IPs from KR
- **`aggregated-us-only.txt`** - 73,765 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 130,943 unique IPs (deduplicated across all countries)
