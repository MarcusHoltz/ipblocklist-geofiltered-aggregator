...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-467027-2D56A8)
...
**Last Updated:** 2026-05-05 18:19:13 UTC
...
- **Total Input IPs:** 467,027
- **Countries Processed:** 6
- **Combined Unique IPs:** 146,636
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 31.40%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 169,198 | 167,680 | 80,919 | 17.33% | `aggregated-us-only.txt` |
| Canada | CA | 16,890 | 16,768 | 10,778 | 2.31% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,411 | 33,252 | 16,246 | 3.48% | `aggregated-gb-only.txt` |
| Australia | AU | 11,396 | 11,317 | 10,986 | 2.35% | `aggregated-au-only.txt` |
| Germany | DE | 28,972 | 28,867 | 21,132 | 4.52% | `aggregated-de-only.txt` |
| South Korea | KR | 4,006 | 3,996 | 6,575 | 1.41% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 467,027 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,986 IPs from AU
- **`aggregated-ca-only.txt`** - 10,778 IPs from CA
- **`aggregated-de-only.txt`** - 21,132 IPs from DE
- **`aggregated-gb-only.txt`** - 16,246 IPs from GB
- **`aggregated-kr-only.txt`** - 6,575 IPs from KR
- **`aggregated-us-only.txt`** - 80,919 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 146,636 unique IPs (deduplicated across all countries)
