...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-440655-2D56A8)
...
- **`aggregated.txt`** - 440,655 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 9,785 IPs from AU
- **`aggregated-ca-only.txt`** - 10,192 IPs from CA
- **`aggregated-de-only.txt`** - 21,332 IPs from DE
- **`aggregated-gb-only.txt`** - 13,554 IPs from GB
- **`aggregated-kr-only.txt`** - 6,240 IPs from KR
- **`aggregated-us-only.txt`** - 79,468 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 140,571 unique IPs (deduplicated across all countries)
