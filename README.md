...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-561405-2D56A8)
...
**Last Updated:** 2025-09-29 14:39:10 UTC
...
- **Total Input IPs:** 561,405
- **Countries Processed:** 6
- **Combined Unique IPs:** 130,626
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.27%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 225,472 | 222,928 | 73,770 | 13.14% | `aggregated-us-only.txt` |
| Canada | CA | 17,937 | 17,822 | 11,248 | 2.00% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,943 | 32,788 | 9,484 | 1.69% | `aggregated-gb-only.txt` |
| Australia | AU | 11,681 | 11,621 | 4,773 | 0.85% | `aggregated-au-only.txt` |
| Germany | DE | 27,612 | 27,495 | 18,118 | 3.23% | `aggregated-de-only.txt` |
| South Korea | KR | 4,005 | 4,004 | 13,233 | 2.36% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 561,405 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,773 IPs from AU
- **`aggregated-ca-only.txt`** - 11,248 IPs from CA
- **`aggregated-de-only.txt`** - 18,118 IPs from DE
- **`aggregated-gb-only.txt`** - 9,484 IPs from GB
- **`aggregated-kr-only.txt`** - 13,233 IPs from KR
- **`aggregated-us-only.txt`** - 73,770 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 130,626 unique IPs (deduplicated across all countries)
