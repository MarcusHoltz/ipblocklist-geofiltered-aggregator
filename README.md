...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-463609-2D56A8)
...
- **`aggregated.txt`** - 463,609 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,991 IPs from AU
- **`aggregated-ca-only.txt`** - 9,945 IPs from CA
- **`aggregated-de-only.txt`** - 16,155 IPs from DE
- **`aggregated-gb-only.txt`** - 9,231 IPs from GB
- **`aggregated-kr-only.txt`** - 12,006 IPs from KR
- **`aggregated-us-only.txt`** - 69,908 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,236 unique IPs (deduplicated across all countries)
