...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-441131-2D56A8)
...
- **`aggregated.txt`** - 441,131 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 9,709 IPs from AU
- **`aggregated-ca-only.txt`** - 10,154 IPs from CA
- **`aggregated-de-only.txt`** - 21,396 IPs from DE
- **`aggregated-gb-only.txt`** - 13,336 IPs from GB
- **`aggregated-kr-only.txt`** - 6,214 IPs from KR
- **`aggregated-us-only.txt`** - 79,138 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 139,947 unique IPs (deduplicated across all countries)
