...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-522533-2D56A8)
...
- **`aggregated.txt`** - 522,533 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,343 IPs from AU
- **`aggregated-ca-only.txt`** - 10,564 IPs from CA
- **`aggregated-de-only.txt`** - 17,054 IPs from DE
- **`aggregated-gb-only.txt`** - 9,514 IPs from GB
- **`aggregated-kr-only.txt`** - 12,627 IPs from KR
- **`aggregated-us-only.txt`** - 70,099 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 124,201 unique IPs (deduplicated across all countries)
