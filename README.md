...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-460206-2D56A8)
...
- **`aggregated.txt`** - 460,206 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,577 IPs from AU
- **`aggregated-ca-only.txt`** - 8,050 IPs from CA
- **`aggregated-de-only.txt`** - 14,875 IPs from DE
- **`aggregated-gb-only.txt`** - 8,717 IPs from GB
- **`aggregated-kr-only.txt`** - 6,261 IPs from KR
- **`aggregated-us-only.txt`** - 87,828 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,308 unique IPs (deduplicated across all countries)
