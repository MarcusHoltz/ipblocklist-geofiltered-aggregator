...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-411440-2D56A8)
...
**Last Updated:** 2025-12-01 14:44:01 UTC
...
- **Total Input IPs:** 411,440
- **Countries Processed:** 6
- **Combined Unique IPs:** 121,296
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 208,627 | 207,128 | 71,919 | 17.48% | `aggregated-us-only.txt` |
| Canada | CA | 17,397 | 17,271 | 8,646 | 2.10% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,084 | 32,951 | 8,790 | 2.14% | `aggregated-gb-only.txt` |
| Australia | AU | 11,257 | 11,196 | 5,376 | 1.31% | `aggregated-au-only.txt` |
| Germany | DE | 27,412 | 27,288 | 15,266 | 3.71% | `aggregated-de-only.txt` |
| South Korea | KR | 4,016 | 4,015 | 11,299 | 2.75% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 411,440 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,376 IPs from AU
- **`aggregated-ca-only.txt`** - 8,646 IPs from CA
- **`aggregated-de-only.txt`** - 15,266 IPs from DE
- **`aggregated-gb-only.txt`** - 8,790 IPs from GB
- **`aggregated-kr-only.txt`** - 11,299 IPs from KR
- **`aggregated-us-only.txt`** - 71,919 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,296 unique IPs (deduplicated across all countries)
