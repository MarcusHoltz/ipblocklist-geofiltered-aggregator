...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-599095-2D56A8)
...
**Last Updated:** 2025-09-14 03:12:19 UTC
...
"United Kingdom" : 1.7
"Australia" : 0.8
"Other/Unfiltered" : 77.2
```

## Overall Summary

- **Total Input IPs:** 599,095
- **Countries Processed:** 6
- **Combined Unique IPs:** 136,327
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 22.76%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 223,146 | 220,769 | 76,034 | 12.69% | `aggregated-us-only.txt` |
| Canada | CA | 17,802 | 17,689 | 11,833 | 1.98% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,651 | 32,492 | 10,076 | 1.68% | `aggregated-gb-only.txt` |
| Australia | AU | 11,651 | 11,596 | 4,897 | 0.82% | `aggregated-au-only.txt` |
| Germany | DE | 27,507 | 27,398 | 19,961 | 3.33% | `aggregated-de-only.txt` |
| South Korea | KR | 3,948 | 3,947 | 13,526 | 2.26% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 599,095 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,897 IPs from AU
- **`aggregated-ca-only.txt`** - 11,833 IPs from CA
- **`aggregated-de-only.txt`** - 19,961 IPs from DE
- **`aggregated-gb-only.txt`** - 10,076 IPs from GB
- **`aggregated-kr-only.txt`** - 13,526 IPs from KR
- **`aggregated-us-only.txt`** - 76,034 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 136,327 unique IPs (deduplicated across all countries)
