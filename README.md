...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-400328-2D56A8)
...
- **`aggregated.txt`** - 400,328 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 8,921 IPs from AU
- **`aggregated-ca-only.txt`** - 9,344 IPs from CA
- **`aggregated-de-only.txt`** - 17,903 IPs from DE
- **`aggregated-gb-only.txt`** - 11,807 IPs from GB
- **`aggregated-kr-only.txt`** - 6,576 IPs from KR
- **`aggregated-us-only.txt`** - 75,527 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 130,078 unique IPs (deduplicated across all countries)
