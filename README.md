...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-427539-2D56A8)
...
**Last Updated:** 2026-03-26 15:44:41 UTC
...
- **Total Input IPs:** 427,539
- **Countries Processed:** 6
- **Combined Unique IPs:** 137,251
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 32.10%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 181,809 | 180,208 | 76,315 | 17.85% | `aggregated-us-only.txt` |
| Canada | CA | 16,866 | 16,741 | 9,848 | 2.30% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,693 | 33,508 | 14,730 | 3.45% | `aggregated-gb-only.txt` |
| Australia | AU | 11,441 | 11,360 | 10,607 | 2.48% | `aggregated-au-only.txt` |
| Germany | DE | 28,381 | 28,291 | 19,192 | 4.49% | `aggregated-de-only.txt` |
| South Korea | KR | 4,031 | 4,020 | 6,559 | 1.53% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 427,539 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,607 IPs from AU
- **`aggregated-ca-only.txt`** - 9,848 IPs from CA
- **`aggregated-de-only.txt`** - 19,192 IPs from DE
- **`aggregated-gb-only.txt`** - 14,730 IPs from GB
- **`aggregated-kr-only.txt`** - 6,559 IPs from KR
- **`aggregated-us-only.txt`** - 76,315 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 137,251 unique IPs (deduplicated across all countries)
