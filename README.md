...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-460020-2D56A8)
...
- **`aggregated.txt`** - 460,020 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 11,101 IPs from AU
- **`aggregated-ca-only.txt`** - 11,084 IPs from CA
- **`aggregated-de-only.txt`** - 23,553 IPs from DE
- **`aggregated-gb-only.txt`** - 16,615 IPs from GB
- **`aggregated-kr-only.txt`** - 6,642 IPs from KR
- **`aggregated-us-only.txt`** - 84,552 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 153,547 unique IPs (deduplicated across all countries)
