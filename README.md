...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-473118-2D56A8)
...
**Last Updated:** 2026-09-05 06:59:24 UTC
...
- **Total Input IPs:** 473,118
- **Countries Processed:** 6
- **Combined Unique IPs:** 139,600
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 29.51%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,784 | 128,927 | 98,616 | 20.84% | `aggregated-us-only.txt` |
| Canada | CA | 17,155 | 17,039 | 7,787 | 1.65% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,780 | 35,619 | 8,678 | 1.83% | `aggregated-gb-only.txt` |
| Australia | AU | 12,241 | 12,174 | 3,600 | 0.76% | `aggregated-au-only.txt` |
| Germany | DE | 29,886 | 29,769 | 14,643 | 3.09% | `aggregated-de-only.txt` |
| South Korea | KR | 3,921 | 3,910 | 6,276 | 1.33% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 473,118 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,600 IPs from AU
- **`aggregated-ca-only.txt`** - 7,787 IPs from CA
- **`aggregated-de-only.txt`** - 14,643 IPs from DE
- **`aggregated-gb-only.txt`** - 8,678 IPs from GB
- **`aggregated-kr-only.txt`** - 6,276 IPs from KR
- **`aggregated-us-only.txt`** - 98,616 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 139,600 unique IPs (deduplicated across all countries)
