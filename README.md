...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-424126-2D56A8)
...
**Last Updated:** 2026-04-23 05:13:54 UTC
...
- **Total Input IPs:** 424,126
- **Countries Processed:** 6
- **Combined Unique IPs:** 133,353
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 31.44%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 172,991 | 171,454 | 73,365 | 17.30% | `aggregated-us-only.txt` |
| Canada | CA | 17,012 | 16,879 | 9,705 | 2.29% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,890 | 33,724 | 14,547 | 3.43% | `aggregated-gb-only.txt` |
| Australia | AU | 11,491 | 11,409 | 10,574 | 2.49% | `aggregated-au-only.txt` |
| Germany | DE | 28,793 | 28,678 | 19,294 | 4.55% | `aggregated-de-only.txt` |
| South Korea | KR | 4,064 | 4,054 | 5,868 | 1.38% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 424,126 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,574 IPs from AU
- **`aggregated-ca-only.txt`** - 9,705 IPs from CA
- **`aggregated-de-only.txt`** - 19,294 IPs from DE
- **`aggregated-gb-only.txt`** - 14,547 IPs from GB
- **`aggregated-kr-only.txt`** - 5,868 IPs from KR
- **`aggregated-us-only.txt`** - 73,365 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 133,353 unique IPs (deduplicated across all countries)
