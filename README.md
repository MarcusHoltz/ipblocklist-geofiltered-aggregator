...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-373758-2D56A8)
...
**Last Updated:** 2026-02-20 15:04:04 UTC
...
- **Total Input IPs:** 373,758
- **Countries Processed:** 6
- **Combined Unique IPs:** 116,416
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 187,917 | 186,299 | 71,800 | 19.21% | `aggregated-us-only.txt` |
| Canada | CA | 16,886 | 16,755 | 8,238 | 2.20% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,949 | 32,783 | 8,844 | 2.37% | `aggregated-gb-only.txt` |
| Australia | AU | 11,393 | 11,327 | 5,735 | 1.53% | `aggregated-au-only.txt` |
| Germany | DE | 27,984 | 27,893 | 14,998 | 4.01% | `aggregated-de-only.txt` |
| South Korea | KR | 4,032 | 4,031 | 6,801 | 1.82% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 373,758 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,735 IPs from AU
- **`aggregated-ca-only.txt`** - 8,238 IPs from CA
- **`aggregated-de-only.txt`** - 14,998 IPs from DE
- **`aggregated-gb-only.txt`** - 8,844 IPs from GB
- **`aggregated-kr-only.txt`** - 6,801 IPs from KR
- **`aggregated-us-only.txt`** - 71,800 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 116,416 unique IPs (deduplicated across all countries)
