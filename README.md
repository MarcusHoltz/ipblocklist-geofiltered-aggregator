...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-462766-2D56A8)
...
**Last Updated:** 2026-08-17 03:16:05 UTC
...
- **Total Input IPs:** 462,766
- **Countries Processed:** 6
- **Combined Unique IPs:** 129,456
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 131,721 | 129,853 | 86,218 | 18.63% | `aggregated-us-only.txt` |
| Canada | CA | 17,158 | 17,035 | 8,038 | 1.74% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,713 | 35,551 | 8,946 | 1.93% | `aggregated-gb-only.txt` |
| Australia | AU | 12,195 | 12,123 | 4,127 | 0.89% | `aggregated-au-only.txt` |
| Germany | DE | 29,761 | 29,693 | 15,752 | 3.40% | `aggregated-de-only.txt` |
| South Korea | KR | 3,928 | 3,918 | 6,375 | 1.38% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 462,766 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,127 IPs from AU
- **`aggregated-ca-only.txt`** - 8,038 IPs from CA
- **`aggregated-de-only.txt`** - 15,752 IPs from DE
- **`aggregated-gb-only.txt`** - 8,946 IPs from GB
- **`aggregated-kr-only.txt`** - 6,375 IPs from KR
- **`aggregated-us-only.txt`** - 86,218 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,456 unique IPs (deduplicated across all countries)
