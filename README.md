...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-558853-2D56A8)
...
**Last Updated:** 2026-01-03 14:37:37 UTC
...
- **Total Input IPs:** 558,853
- **Countries Processed:** 6
- **Combined Unique IPs:** 184,541
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 33.02%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 199,419 | 197,811 | 116,483 | 20.84% | `aggregated-us-only.txt` |
| Canada | CA | 17,248 | 17,118 | 13,072 | 2.34% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,774 | 33,608 | 13,119 | 2.35% | `aggregated-gb-only.txt` |
| Australia | AU | 11,596 | 11,526 | 6,013 | 1.08% | `aggregated-au-only.txt` |
| Germany | DE | 27,528 | 27,389 | 21,409 | 3.83% | `aggregated-de-only.txt` |
| South Korea | KR | 3,990 | 3,989 | 14,445 | 2.58% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 558,853 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 6,013 IPs from AU
- **`aggregated-ca-only.txt`** - 13,072 IPs from CA
- **`aggregated-de-only.txt`** - 21,409 IPs from DE
- **`aggregated-gb-only.txt`** - 13,119 IPs from GB
- **`aggregated-kr-only.txt`** - 14,445 IPs from KR
- **`aggregated-us-only.txt`** - 116,483 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 184,541 unique IPs (deduplicated across all countries)
