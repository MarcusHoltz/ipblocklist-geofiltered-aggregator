...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-549065-2D56A8)
...
**Last Updated:** 2025-10-02 03:08:11 UTC
...
- **Total Input IPs:** 549,065
- **Countries Processed:** 6
- **Combined Unique IPs:** 129,342
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 225,472 | 222,928 | 73,104 | 13.31% | `aggregated-us-only.txt` |
| Canada | CA | 17,937 | 17,822 | 11,037 | 2.01% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,943 | 32,788 | 9,409 | 1.71% | `aggregated-gb-only.txt` |
| Australia | AU | 11,681 | 11,621 | 4,694 | 0.85% | `aggregated-au-only.txt` |
| Germany | DE | 27,612 | 27,495 | 18,060 | 3.29% | `aggregated-de-only.txt` |
| South Korea | KR | 4,005 | 4,004 | 13,038 | 2.37% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 549,065 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,694 IPs from AU
- **`aggregated-ca-only.txt`** - 11,037 IPs from CA
- **`aggregated-de-only.txt`** - 18,060 IPs from DE
- **`aggregated-gb-only.txt`** - 9,409 IPs from GB
- **`aggregated-kr-only.txt`** - 13,038 IPs from KR
- **`aggregated-us-only.txt`** - 73,104 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,342 unique IPs (deduplicated across all countries)
