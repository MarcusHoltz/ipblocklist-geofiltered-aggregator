...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-744214-2D56A8)
...
- **`aggregated.txt`** - 744,214 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,339 IPs from AU
- **`aggregated-ca-only.txt`** - 11,696 IPs from CA
- **`aggregated-de-only.txt`** - 22,705 IPs from DE
- **`aggregated-gb-only.txt`** - 14,410 IPs from GB
- **`aggregated-kr-only.txt`** - 10,719 IPs from KR
- **`aggregated-us-only.txt`** - 155,173 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 220,042 unique IPs (deduplicated across all countries)
