...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-410860-2D56A8)
...
**Last Updated:** 2025-12-16 03:44:21 UTC
...
- **Total Input IPs:** 410,860
- **Countries Processed:** 6
- **Combined Unique IPs:** 124,602
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 205,029 | 203,447 | 74,454 | 18.12% | `aggregated-us-only.txt` |
| Canada | CA | 17,534 | 17,408 | 8,479 | 2.06% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,613 | 33,458 | 9,499 | 2.31% | `aggregated-gb-only.txt` |
| Australia | AU | 11,630 | 11,560 | 5,564 | 1.35% | `aggregated-au-only.txt` |
| Germany | DE | 27,435 | 27,295 | 15,868 | 3.86% | `aggregated-de-only.txt` |
| South Korea | KR | 3,986 | 3,985 | 10,738 | 2.61% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 410,860 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,564 IPs from AU
- **`aggregated-ca-only.txt`** - 8,479 IPs from CA
- **`aggregated-de-only.txt`** - 15,868 IPs from DE
- **`aggregated-gb-only.txt`** - 9,499 IPs from GB
- **`aggregated-kr-only.txt`** - 10,738 IPs from KR
- **`aggregated-us-only.txt`** - 74,454 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 124,602 unique IPs (deduplicated across all countries)
