...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-381799-2D56A8)
...
- **`aggregated.txt`** - 381,799 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,403 IPs from AU
- **`aggregated-ca-only.txt`** - 9,032 IPs from CA
- **`aggregated-de-only.txt`** - 15,011 IPs from DE
- **`aggregated-gb-only.txt`** - 8,588 IPs from GB
- **`aggregated-kr-only.txt`** - 7,695 IPs from KR
- **`aggregated-us-only.txt`** - 72,820 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 118,549 unique IPs (deduplicated across all countries)
