...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-363228-2D56A8)
...
**Last Updated:** 2025-08-27 15:07:28 UTC
...
- **`aggregated.txt`** - 363,228 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,001 IPs from AU
- **`aggregated-ca-only.txt`** - 3,150 IPs from CA
- **`aggregated-de-only.txt`** - 6,416 IPs from DE
- **`aggregated-gb-only.txt`** - 5,337 IPs from GB
- **`aggregated-kr-only.txt`** - 4,124 IPs from KR
- **`aggregated-us-only.txt`** - 31,658 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 53,686 unique IPs (deduplicated across all countries)
