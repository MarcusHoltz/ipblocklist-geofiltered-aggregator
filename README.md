...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-436186-2D56A8)
...
**Last Updated:** 2026-05-30 15:40:12 UTC
...
"Australia" : 2.5
"South Korea" : 1.3
"Other/Unfiltered" : 65.8
```

## Overall Summary

- **Total Input IPs:** 436,186
- **Countries Processed:** 6
- **Combined Unique IPs:** 149,015
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 34.16%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 166,410 | 164,906 | 81,100 | 18.59% | `aggregated-us-only.txt` |
| Canada | CA | 17,069 | 16,942 | 11,532 | 2.64% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 34,140 | 33,965 | 16,479 | 3.78% | `aggregated-gb-only.txt` |
| Australia | AU | 12,081 | 12,011 | 11,003 | 2.52% | `aggregated-au-only.txt` |
| Germany | DE | 28,870 | 28,778 | 23,106 | 5.30% | `aggregated-de-only.txt` |
| South Korea | KR | 3,959 | 3,949 | 5,795 | 1.33% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 436,186 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 11,003 IPs from AU
- **`aggregated-ca-only.txt`** - 11,532 IPs from CA
- **`aggregated-de-only.txt`** - 23,106 IPs from DE
- **`aggregated-gb-only.txt`** - 16,479 IPs from GB
- **`aggregated-kr-only.txt`** - 5,795 IPs from KR
- **`aggregated-us-only.txt`** - 81,100 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 149,015 unique IPs (deduplicated across all countries)
