...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-457737-2D56A8)
...
**Last Updated:** 2026-05-23 15:35:09 UTC
...
- **Total Input IPs:** 457,737
- **Countries Processed:** 6
- **Combined Unique IPs:** 155,356
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 33.94%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,217 | 165,713 | 84,543 | 18.47% | `aggregated-us-only.txt` |
| Canada | CA | 17,079 | 16,951 | 12,714 | 2.78% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,930 | 33,764 | 17,334 | 3.79% | `aggregated-gb-only.txt` |
| Australia | AU | 12,099 | 12,029 | 11,175 | 2.44% | `aggregated-au-only.txt` |
| Germany | DE | 28,842 | 28,762 | 22,976 | 5.02% | `aggregated-de-only.txt` |
| South Korea | KR | 3,976 | 3,966 | 6,614 | 1.44% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 457,737 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 11,175 IPs from AU
- **`aggregated-ca-only.txt`** - 12,714 IPs from CA
- **`aggregated-de-only.txt`** - 22,976 IPs from DE
- **`aggregated-gb-only.txt`** - 17,334 IPs from GB
- **`aggregated-kr-only.txt`** - 6,614 IPs from KR
- **`aggregated-us-only.txt`** - 84,543 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 155,356 unique IPs (deduplicated across all countries)
