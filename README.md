...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-458051-2D56A8)
...
**Last Updated:** 2026-04-27 16:02:11 UTC
...
- **Total Input IPs:** 458,051
- **Countries Processed:** 6
- **Combined Unique IPs:** 140,356
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 171,324 | 169,740 | 77,067 | 16.82% | `aggregated-us-only.txt` |
| Canada | CA | 17,021 | 16,892 | 10,302 | 2.25% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,972 | 33,814 | 15,376 | 3.36% | `aggregated-gb-only.txt` |
| Australia | AU | 11,465 | 11,383 | 10,724 | 2.34% | `aggregated-au-only.txt` |
| Germany | DE | 29,039 | 28,924 | 20,203 | 4.41% | `aggregated-de-only.txt` |
| South Korea | KR | 4,071 | 4,061 | 6,684 | 1.46% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 458,051 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,724 IPs from AU
- **`aggregated-ca-only.txt`** - 10,302 IPs from CA
- **`aggregated-de-only.txt`** - 20,203 IPs from DE
- **`aggregated-gb-only.txt`** - 15,376 IPs from GB
- **`aggregated-kr-only.txt`** - 6,684 IPs from KR
- **`aggregated-us-only.txt`** - 77,067 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 140,356 unique IPs (deduplicated across all countries)
