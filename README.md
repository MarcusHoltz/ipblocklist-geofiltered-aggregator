...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-398400-2D56A8)
...
- **`aggregated.txt`** - 398,400 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 8,839 IPs from AU
- **`aggregated-ca-only.txt`** - 8,927 IPs from CA
- **`aggregated-de-only.txt`** - 17,862 IPs from DE
- **`aggregated-gb-only.txt`** - 11,953 IPs from GB
- **`aggregated-kr-only.txt`** - 6,575 IPs from KR
- **`aggregated-us-only.txt`** - 74,981 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,137 unique IPs (deduplicated across all countries)
