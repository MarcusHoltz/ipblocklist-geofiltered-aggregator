...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-521430-2D56A8)
...
**Last Updated:** 2025-10-12 14:32:22 UTC
...
- **Total Input IPs:** 521,430
- **Countries Processed:** 6
- **Combined Unique IPs:** 123,149
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.62%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 227,690 | 225,148 | 69,324 | 13.29% | `aggregated-us-only.txt` |
| Canada | CA | 17,925 | 17,808 | 10,533 | 2.02% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,170 | 33,025 | 9,417 | 1.81% | `aggregated-gb-only.txt` |
| Australia | AU | 11,608 | 11,551 | 4,298 | 0.82% | `aggregated-au-only.txt` |
| Germany | DE | 27,833 | 27,710 | 16,912 | 3.24% | `aggregated-de-only.txt` |
| South Korea | KR | 4,022 | 4,021 | 12,665 | 2.43% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 521,430 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,298 IPs from AU
- **`aggregated-ca-only.txt`** - 10,533 IPs from CA
- **`aggregated-de-only.txt`** - 16,912 IPs from DE
- **`aggregated-gb-only.txt`** - 9,417 IPs from GB
- **`aggregated-kr-only.txt`** - 12,665 IPs from KR
- **`aggregated-us-only.txt`** - 69,324 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,149 unique IPs (deduplicated across all countries)
