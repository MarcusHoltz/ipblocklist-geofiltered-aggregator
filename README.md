...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-432104-2D56A8)
...
- **`aggregated.txt`** - 432,104 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,560 IPs from AU
- **`aggregated-ca-only.txt`** - 9,429 IPs from CA
- **`aggregated-de-only.txt`** - 19,132 IPs from DE
- **`aggregated-gb-only.txt`** - 14,756 IPs from GB
- **`aggregated-kr-only.txt`** - 6,505 IPs from KR
- **`aggregated-us-only.txt`** - 75,237 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 135,619 unique IPs (deduplicated across all countries)
