...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-416440-2D56A8)
...
**Last Updated:** 2026-03-15 04:42:47 UTC
...
- **Total Input IPs:** 416,440
- **Countries Processed:** 6
- **Combined Unique IPs:** 135,778
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 32.60%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 182,037 | 180,421 | 77,356 | 18.58% | `aggregated-us-only.txt` |
| Canada | CA | 16,831 | 16,710 | 9,397 | 2.26% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,542 | 33,383 | 14,015 | 3.37% | `aggregated-gb-only.txt` |
| Australia | AU | 11,394 | 11,313 | 10,196 | 2.45% | `aggregated-au-only.txt` |
| Germany | DE | 28,759 | 28,678 | 18,299 | 4.39% | `aggregated-de-only.txt` |
| South Korea | KR | 4,059 | 4,048 | 6,515 | 1.56% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 416,440 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,196 IPs from AU
- **`aggregated-ca-only.txt`** - 9,397 IPs from CA
- **`aggregated-de-only.txt`** - 18,299 IPs from DE
- **`aggregated-gb-only.txt`** - 14,015 IPs from GB
- **`aggregated-kr-only.txt`** - 6,515 IPs from KR
- **`aggregated-us-only.txt`** - 77,356 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 135,778 unique IPs (deduplicated across all countries)
