...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-374684-2D56A8)
...
- **`aggregated.txt`** - 374,684 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 6,121 IPs from AU
- **`aggregated-ca-only.txt`** - 8,283 IPs from CA
- **`aggregated-de-only.txt`** - 15,307 IPs from DE
- **`aggregated-gb-only.txt`** - 8,791 IPs from GB
- **`aggregated-kr-only.txt`** - 6,807 IPs from KR
- **`aggregated-us-only.txt`** - 72,079 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 117,388 unique IPs (deduplicated across all countries)
