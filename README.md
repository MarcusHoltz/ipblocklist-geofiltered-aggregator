...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-444569-2D56A8)
...
- **`aggregated.txt`** - 444,569 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 9,159 IPs from AU
- **`aggregated-ca-only.txt`** - 9,373 IPs from CA
- **`aggregated-de-only.txt`** - 21,056 IPs from DE
- **`aggregated-gb-only.txt`** - 12,110 IPs from GB
- **`aggregated-kr-only.txt`** - 6,410 IPs from KR
- **`aggregated-us-only.txt`** - 78,398 IPs from US
