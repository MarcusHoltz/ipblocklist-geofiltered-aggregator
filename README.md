...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-398316-2D56A8)
...
- **`aggregated.txt`** - 398,316 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 8,962 IPs from AU
- **`aggregated-ca-only.txt`** - 9,313 IPs from CA
- **`aggregated-de-only.txt`** - 17,814 IPs from DE
- **`aggregated-gb-only.txt`** - 11,866 IPs from GB
- **`aggregated-kr-only.txt`** - 6,552 IPs from KR
- **`aggregated-us-only.txt`** - 75,026 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,533 unique IPs (deduplicated across all countries)
