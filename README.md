...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-431461-2D56A8)
...
**Last Updated:** 2026-07-01 16:42:32 UTC
...
- **Total Input IPs:** 431,461
- **Countries Processed:** 6
- **Combined Unique IPs:** 142,121
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 32.94%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 149,937 | 148,118 | 78,529 | 18.20% | `aggregated-us-only.txt` |
| Canada | CA | 16,781 | 16,649 | 10,350 | 2.40% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,005 | 34,838 | 14,751 | 3.42% | `aggregated-gb-only.txt` |
| Australia | AU | 12,035 | 11,960 | 10,545 | 2.44% | `aggregated-au-only.txt` |
| Germany | DE | 28,921 | 28,848 | 21,679 | 5.02% | `aggregated-de-only.txt` |
| South Korea | KR | 3,914 | 3,904 | 6,267 | 1.45% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 431,461 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,545 IPs from AU
- **`aggregated-ca-only.txt`** - 10,350 IPs from CA
- **`aggregated-de-only.txt`** - 21,679 IPs from DE
- **`aggregated-gb-only.txt`** - 14,751 IPs from GB
- **`aggregated-kr-only.txt`** - 6,267 IPs from KR
- **`aggregated-us-only.txt`** - 78,529 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 142,121 unique IPs (deduplicated across all countries)
