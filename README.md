...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-426175-2D56A8)
...
**Last Updated:** 2025-12-25 03:46:07 UTC
...
- **Total Input IPs:** 426,175
- **Countries Processed:** 6
- **Combined Unique IPs:** 124,904
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 201,619 | 200,020 | 73,986 | 17.36% | `aggregated-us-only.txt` |
| Canada | CA | 17,339 | 17,213 | 8,428 | 1.98% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,812 | 33,657 | 9,128 | 2.14% | `aggregated-gb-only.txt` |
| Australia | AU | 11,538 | 11,468 | 5,743 | 1.35% | `aggregated-au-only.txt` |
| Germany | DE | 27,526 | 27,387 | 17,044 | 4.00% | `aggregated-de-only.txt` |
| South Korea | KR | 4,005 | 4,004 | 10,575 | 2.48% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 426,175 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,743 IPs from AU
- **`aggregated-ca-only.txt`** - 8,428 IPs from CA
- **`aggregated-de-only.txt`** - 17,044 IPs from DE
- **`aggregated-gb-only.txt`** - 9,128 IPs from GB
- **`aggregated-kr-only.txt`** - 10,575 IPs from KR
- **`aggregated-us-only.txt`** - 73,986 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 124,904 unique IPs (deduplicated across all countries)
