...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-424757-2D56A8)
...
**Last Updated:** 2026-06-05 06:45:57 UTC
...
- **Total Input IPs:** 424,757
- **Countries Processed:** 6
- **Combined Unique IPs:** 149,159
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 35.12%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 165,171 | 163,351 | 82,655 | 19.46% | `aggregated-us-only.txt` |
| Canada | CA | 17,038 | 16,909 | 10,978 | 2.58% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 34,022 | 33,847 | 16,388 | 3.86% | `aggregated-gb-only.txt` |
| Australia | AU | 12,034 | 11,967 | 10,842 | 2.55% | `aggregated-au-only.txt` |
| Germany | DE | 28,948 | 28,868 | 22,648 | 5.33% | `aggregated-de-only.txt` |
| South Korea | KR | 3,938 | 3,928 | 5,648 | 1.33% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 424,757 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,842 IPs from AU
- **`aggregated-ca-only.txt`** - 10,978 IPs from CA
- **`aggregated-de-only.txt`** - 22,648 IPs from DE
- **`aggregated-gb-only.txt`** - 16,388 IPs from GB
- **`aggregated-kr-only.txt`** - 5,648 IPs from KR
- **`aggregated-us-only.txt`** - 82,655 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 149,159 unique IPs (deduplicated across all countries)
