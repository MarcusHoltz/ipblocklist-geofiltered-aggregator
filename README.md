...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-429936-2D56A8)
...
**Last Updated:** 2026-04-18 15:01:32 UTC
...
- **Total Input IPs:** 429,936
- **Countries Processed:** 6
- **Combined Unique IPs:** 135,482
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 31.51%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 174,297 | 172,744 | 74,785 | 17.39% | `aggregated-us-only.txt` |
| Canada | CA | 16,926 | 16,789 | 9,895 | 2.30% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,790 | 33,627 | 14,589 | 3.39% | `aggregated-gb-only.txt` |
| Australia | AU | 11,413 | 11,331 | 10,602 | 2.47% | `aggregated-au-only.txt` |
| Germany | DE | 28,732 | 28,618 | 19,594 | 4.56% | `aggregated-de-only.txt` |
| South Korea | KR | 4,047 | 4,037 | 6,017 | 1.40% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 429,936 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,602 IPs from AU
- **`aggregated-ca-only.txt`** - 9,895 IPs from CA
- **`aggregated-de-only.txt`** - 19,594 IPs from DE
- **`aggregated-gb-only.txt`** - 14,589 IPs from GB
- **`aggregated-kr-only.txt`** - 6,017 IPs from KR
- **`aggregated-us-only.txt`** - 74,785 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 135,482 unique IPs (deduplicated across all countries)
