...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-433764-2D56A8)
...
**Last Updated:** 2026-05-30 05:58:11 UTC
...
- **Total Input IPs:** 433,764
- **Countries Processed:** 6
- **Combined Unique IPs:** 147,729
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 34.06%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 166,410 | 164,906 | 80,903 | 18.65% | `aggregated-us-only.txt` |
| Canada | CA | 17,069 | 16,942 | 10,614 | 2.45% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 34,140 | 33,965 | 16,365 | 3.77% | `aggregated-gb-only.txt` |
| Australia | AU | 12,081 | 12,011 | 10,984 | 2.53% | `aggregated-au-only.txt` |
| Germany | DE | 28,870 | 28,778 | 23,078 | 5.32% | `aggregated-de-only.txt` |
| South Korea | KR | 3,959 | 3,949 | 5,785 | 1.33% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 433,764 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,984 IPs from AU
- **`aggregated-ca-only.txt`** - 10,614 IPs from CA
- **`aggregated-de-only.txt`** - 23,078 IPs from DE
- **`aggregated-gb-only.txt`** - 16,365 IPs from GB
- **`aggregated-kr-only.txt`** - 5,785 IPs from KR
- **`aggregated-us-only.txt`** - 80,903 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 147,729 unique IPs (deduplicated across all countries)
