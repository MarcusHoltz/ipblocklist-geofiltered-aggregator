...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-440564-2D56A8)
...
- **`aggregated.txt`** - 440,564 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,297 IPs from AU
- **`aggregated-ca-only.txt`** - 9,393 IPs from CA
- **`aggregated-de-only.txt`** - 15,689 IPs from DE
- **`aggregated-gb-only.txt`** - 9,097 IPs from GB
- **`aggregated-kr-only.txt`** - 11,687 IPs from KR
- **`aggregated-us-only.txt`** - 68,901 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 119,064 unique IPs (deduplicated across all countries)
