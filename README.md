...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-436011-2D56A8)
...
**Last Updated:** 2026-07-08 05:33:57 UTC
...
- **Total Input IPs:** 436,011
- **Countries Processed:** 6
- **Combined Unique IPs:** 140,690
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 32.27%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 146,470 | 144,657 | 79,602 | 18.26% | `aggregated-us-only.txt` |
| Canada | CA | 16,851 | 16,729 | 10,151 | 2.33% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,133 | 34,962 | 13,819 | 3.17% | `aggregated-gb-only.txt` |
| Australia | AU | 12,084 | 12,012 | 9,845 | 2.26% | `aggregated-au-only.txt` |
| Germany | DE | 29,016 | 28,930 | 21,018 | 4.82% | `aggregated-de-only.txt` |
| South Korea | KR | 3,913 | 3,903 | 6,255 | 1.43% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 436,011 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 9,845 IPs from AU
- **`aggregated-ca-only.txt`** - 10,151 IPs from CA
- **`aggregated-de-only.txt`** - 21,018 IPs from DE
- **`aggregated-gb-only.txt`** - 13,819 IPs from GB
- **`aggregated-kr-only.txt`** - 6,255 IPs from KR
- **`aggregated-us-only.txt`** - 79,602 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 140,690 unique IPs (deduplicated across all countries)
