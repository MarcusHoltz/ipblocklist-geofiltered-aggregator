...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-525587-2D56A8)
...
- **`aggregated.txt`** - 525,587 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,247 IPs from AU
- **`aggregated-ca-only.txt`** - 10,625 IPs from CA
- **`aggregated-de-only.txt`** - 17,042 IPs from DE
- **`aggregated-gb-only.txt`** - 9,413 IPs from GB
- **`aggregated-kr-only.txt`** - 12,760 IPs from KR
- **`aggregated-us-only.txt`** - 69,821 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,908 unique IPs (deduplicated across all countries)
