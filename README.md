...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-421913-2D56A8)
...
**Last Updated:** 2026-06-06 15:44:20 UTC
...
- **Total Input IPs:** 421,913
- **Countries Processed:** 6
- **Combined Unique IPs:** 147,531
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 34.97%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 165,171 | 163,351 | 81,250 | 19.26% | `aggregated-us-only.txt` |
| Canada | CA | 17,038 | 16,909 | 11,291 | 2.68% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 34,022 | 33,847 | 15,903 | 3.77% | `aggregated-gb-only.txt` |
| Australia | AU | 12,034 | 11,967 | 10,837 | 2.57% | `aggregated-au-only.txt` |
| Germany | DE | 28,948 | 28,868 | 22,661 | 5.37% | `aggregated-de-only.txt` |
| South Korea | KR | 3,938 | 3,928 | 5,589 | 1.32% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 421,913 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,837 IPs from AU
- **`aggregated-ca-only.txt`** - 11,291 IPs from CA
- **`aggregated-de-only.txt`** - 22,661 IPs from DE
- **`aggregated-gb-only.txt`** - 15,903 IPs from GB
- **`aggregated-kr-only.txt`** - 5,589 IPs from KR
- **`aggregated-us-only.txt`** - 81,250 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 147,531 unique IPs (deduplicated across all countries)
