...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-553423-2D56A8)
...
**Last Updated:** 2025-10-01 14:39:29 UTC
...
- **Total Input IPs:** 553,423
- **Countries Processed:** 6
- **Combined Unique IPs:** 129,989
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.49%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 225,472 | 222,928 | 73,476 | 13.28% | `aggregated-us-only.txt` |
| Canada | CA | 17,937 | 17,822 | 11,120 | 2.01% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,943 | 32,788 | 9,432 | 1.70% | `aggregated-gb-only.txt` |
| Australia | AU | 11,681 | 11,621 | 4,729 | 0.85% | `aggregated-au-only.txt` |
| Germany | DE | 27,612 | 27,495 | 18,104 | 3.27% | `aggregated-de-only.txt` |
| South Korea | KR | 4,005 | 4,004 | 13,128 | 2.37% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 553,423 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,729 IPs from AU
- **`aggregated-ca-only.txt`** - 11,120 IPs from CA
- **`aggregated-de-only.txt`** - 18,104 IPs from DE
- **`aggregated-gb-only.txt`** - 9,432 IPs from GB
- **`aggregated-kr-only.txt`** - 13,128 IPs from KR
- **`aggregated-us-only.txt`** - 73,476 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,989 unique IPs (deduplicated across all countries)
