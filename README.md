...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-461643-2D56A8)
...
- **`aggregated.txt`** - 461,643 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,130 IPs from AU
- **`aggregated-ca-only.txt`** - 9,928 IPs from CA
- **`aggregated-de-only.txt`** - 16,072 IPs from DE
- **`aggregated-gb-only.txt`** - 9,340 IPs from GB
- **`aggregated-kr-only.txt`** - 12,036 IPs from KR
- **`aggregated-us-only.txt`** - 70,431 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,937 unique IPs (deduplicated across all countries)
