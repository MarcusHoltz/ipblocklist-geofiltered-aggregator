...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-472361-2D56A8)
...
**Last Updated:** 2026-09-04 07:18:12 UTC
...
- **Total Input IPs:** 472,361
- **Countries Processed:** 6
- **Combined Unique IPs:** 139,635
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,784 | 128,927 | 98,538 | 20.86% | `aggregated-us-only.txt` |
| Canada | CA | 17,155 | 17,039 | 7,795 | 1.65% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,780 | 35,619 | 8,825 | 1.87% | `aggregated-gb-only.txt` |
| Australia | AU | 12,241 | 12,174 | 3,582 | 0.76% | `aggregated-au-only.txt` |
| Germany | DE | 29,886 | 29,769 | 14,638 | 3.10% | `aggregated-de-only.txt` |
| South Korea | KR | 3,921 | 3,910 | 6,257 | 1.32% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 472,361 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,582 IPs from AU
- **`aggregated-ca-only.txt`** - 7,795 IPs from CA
- **`aggregated-de-only.txt`** - 14,638 IPs from DE
- **`aggregated-gb-only.txt`** - 8,825 IPs from GB
- **`aggregated-kr-only.txt`** - 6,257 IPs from KR
- **`aggregated-us-only.txt`** - 98,538 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 139,635 unique IPs (deduplicated across all countries)
