...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-429864-2D56A8)
...
- **`aggregated.txt`** - 429,864 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,941 IPs from AU
- **`aggregated-ca-only.txt`** - 11,014 IPs from CA
- **`aggregated-de-only.txt`** - 23,686 IPs from DE
- **`aggregated-gb-only.txt`** - 16,039 IPs from GB
- **`aggregated-kr-only.txt`** - 5,670 IPs from KR
- **`aggregated-us-only.txt`** - 83,249 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 150,599 unique IPs (deduplicated across all countries)
