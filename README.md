...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-401125-2D56A8)
...
**Last Updated:** 2025-11-23 03:44:35 UTC
...
- **Total Input IPs:** 401,125
- **Countries Processed:** 6
- **Combined Unique IPs:** 115,613
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 28.82%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 209,952 | 208,501 | 67,857 | 16.92% | `aggregated-us-only.txt` |
| Canada | CA | 17,580 | 17,458 | 8,688 | 2.17% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,180 | 33,043 | 8,363 | 2.08% | `aggregated-gb-only.txt` |
| Australia | AU | 11,254 | 11,184 | 5,090 | 1.27% | `aggregated-au-only.txt` |
| Germany | DE | 27,344 | 27,217 | 14,864 | 3.71% | `aggregated-de-only.txt` |
| South Korea | KR | 4,023 | 4,022 | 10,751 | 2.68% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 401,125 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,090 IPs from AU
- **`aggregated-ca-only.txt`** - 8,688 IPs from CA
- **`aggregated-de-only.txt`** - 14,864 IPs from DE
- **`aggregated-gb-only.txt`** - 8,363 IPs from GB
- **`aggregated-kr-only.txt`** - 10,751 IPs from KR
- **`aggregated-us-only.txt`** - 67,857 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 115,613 unique IPs (deduplicated across all countries)
