...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-423625-2D56A8)
...
**Last Updated:** 2026-06-02 07:00:49 UTC
...
- **Total Input IPs:** 423,625
- **Countries Processed:** 6
- **Combined Unique IPs:** 146,947
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 34.69%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 165,171 | 163,351 | 80,151 | 18.92% | `aggregated-us-only.txt` |
| Canada | CA | 17,038 | 16,909 | 11,395 | 2.69% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 34,022 | 33,847 | 16,018 | 3.78% | `aggregated-gb-only.txt` |
| Australia | AU | 12,034 | 11,967 | 10,920 | 2.58% | `aggregated-au-only.txt` |
| Germany | DE | 28,948 | 28,868 | 22,776 | 5.38% | `aggregated-de-only.txt` |
| South Korea | KR | 3,938 | 3,928 | 5,687 | 1.34% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 423,625 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,920 IPs from AU
- **`aggregated-ca-only.txt`** - 11,395 IPs from CA
- **`aggregated-de-only.txt`** - 22,776 IPs from DE
- **`aggregated-gb-only.txt`** - 16,018 IPs from GB
- **`aggregated-kr-only.txt`** - 5,687 IPs from KR
- **`aggregated-us-only.txt`** - 80,151 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 146,947 unique IPs (deduplicated across all countries)
