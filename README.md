...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-482005-2D56A8)
...
- **`aggregated.txt`** - 482,005 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,043 IPs from AU
- **`aggregated-ca-only.txt`** - 10,117 IPs from CA
...
- **`aggregated-us-only.txt`** - 70,086 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,966 unique IPs (deduplicated across all countries)
