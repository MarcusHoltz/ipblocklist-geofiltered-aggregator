...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-437791-2D56A8)
...
**Last Updated:** 2026-06-19 07:32:48 UTC
...
- **Total Input IPs:** 437,791
- **Countries Processed:** 6
- **Combined Unique IPs:** 152,191
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 34.76%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 162,102 | 160,287 | 83,572 | 19.09% | `aggregated-us-only.txt` |
| Canada | CA | 16,986 | 16,858 | 11,945 | 2.73% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,600 | 35,425 | 15,945 | 3.64% | `aggregated-gb-only.txt` |
| Australia | AU | 12,043 | 11,960 | 11,120 | 2.54% | `aggregated-au-only.txt` |
| Germany | DE | 28,808 | 28,728 | 23,497 | 5.37% | `aggregated-de-only.txt` |
| South Korea | KR | 3,954 | 3,944 | 6,112 | 1.40% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 437,791 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 11,120 IPs from AU
- **`aggregated-ca-only.txt`** - 11,945 IPs from CA
- **`aggregated-de-only.txt`** - 23,497 IPs from DE
- **`aggregated-gb-only.txt`** - 15,945 IPs from GB
- **`aggregated-kr-only.txt`** - 6,112 IPs from KR
- **`aggregated-us-only.txt`** - 83,572 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 152,191 unique IPs (deduplicated across all countries)
