...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-426790-2D56A8)
...
**Last Updated:** 2026-03-18 15:42:13 UTC
...
- **Total Input IPs:** 426,790
- **Countries Processed:** 6
- **Combined Unique IPs:** 139,123
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 182,037 | 180,421 | 78,396 | 18.37% | `aggregated-us-only.txt` |
| Canada | CA | 16,831 | 16,710 | 9,872 | 2.31% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,542 | 33,383 | 14,516 | 3.40% | `aggregated-gb-only.txt` |
| Australia | AU | 11,394 | 11,313 | 10,802 | 2.53% | `aggregated-au-only.txt` |
| Germany | DE | 28,759 | 28,678 | 18,984 | 4.45% | `aggregated-de-only.txt` |
| South Korea | KR | 4,059 | 4,048 | 6,553 | 1.54% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 426,790 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,802 IPs from AU
- **`aggregated-ca-only.txt`** - 9,872 IPs from CA
- **`aggregated-de-only.txt`** - 18,984 IPs from DE
- **`aggregated-gb-only.txt`** - 14,516 IPs from GB
- **`aggregated-kr-only.txt`** - 6,553 IPs from KR
- **`aggregated-us-only.txt`** - 78,396 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 139,123 unique IPs (deduplicated across all countries)
