...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-557123-2D56A8)
...
**Last Updated:** 2026-01-04 04:00:09 UTC
...
- **Total Input IPs:** 557,123
- **Countries Processed:** 6
- **Combined Unique IPs:** 183,810
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 32.99%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 196,770 | 195,158 | 116,122 | 20.84% | `aggregated-us-only.txt` |
| Canada | CA | 17,228 | 17,102 | 12,995 | 2.33% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,886 | 33,721 | 13,048 | 2.34% | `aggregated-gb-only.txt` |
| Australia | AU | 11,593 | 11,526 | 5,921 | 1.06% | `aggregated-au-only.txt` |
| Germany | DE | 27,570 | 27,431 | 21,373 | 3.84% | `aggregated-de-only.txt` |
| South Korea | KR | 3,983 | 3,982 | 14,351 | 2.58% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 557,123 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,921 IPs from AU
- **`aggregated-ca-only.txt`** - 12,995 IPs from CA
- **`aggregated-de-only.txt`** - 21,373 IPs from DE
- **`aggregated-gb-only.txt`** - 13,048 IPs from GB
- **`aggregated-kr-only.txt`** - 14,351 IPs from KR
- **`aggregated-us-only.txt`** - 116,122 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 183,810 unique IPs (deduplicated across all countries)
