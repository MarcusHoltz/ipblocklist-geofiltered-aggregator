...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-463211-2D56A8)
...
**Last Updated:** 2026-04-28 05:43:04 UTC
...
- **Total Input IPs:** 463,211
- **Countries Processed:** 6
- **Combined Unique IPs:** 140,407
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 30.31%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 171,324 | 169,740 | 77,096 | 16.64% | `aggregated-us-only.txt` |
| Canada | CA | 17,021 | 16,892 | 10,287 | 2.22% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,972 | 33,814 | 15,449 | 3.34% | `aggregated-gb-only.txt` |
| Australia | AU | 11,465 | 11,383 | 10,725 | 2.32% | `aggregated-au-only.txt` |
| Germany | DE | 29,039 | 28,924 | 20,206 | 4.36% | `aggregated-de-only.txt` |
| South Korea | KR | 4,071 | 4,061 | 6,644 | 1.43% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 463,211 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,725 IPs from AU
- **`aggregated-ca-only.txt`** - 10,287 IPs from CA
- **`aggregated-de-only.txt`** - 20,206 IPs from DE
- **`aggregated-gb-only.txt`** - 15,449 IPs from GB
- **`aggregated-kr-only.txt`** - 6,644 IPs from KR
- **`aggregated-us-only.txt`** - 77,096 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 140,407 unique IPs (deduplicated across all countries)
