...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-455559-2D56A8)
...
**Last Updated:** 2026-05-08 15:54:42 UTC
...
- **Total Input IPs:** 455,559
- **Countries Processed:** 6
- **Combined Unique IPs:** 145,346
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 169,198 | 167,680 | 79,868 | 17.53% | `aggregated-us-only.txt` |
| Canada | CA | 16,890 | 16,768 | 10,824 | 2.38% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,411 | 33,252 | 16,169 | 3.55% | `aggregated-gb-only.txt` |
| Australia | AU | 11,396 | 11,317 | 10,919 | 2.40% | `aggregated-au-only.txt` |
| Germany | DE | 28,972 | 28,867 | 21,002 | 4.61% | `aggregated-de-only.txt` |
| South Korea | KR | 4,006 | 3,996 | 6,564 | 1.44% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 455,559 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,919 IPs from AU
- **`aggregated-ca-only.txt`** - 10,824 IPs from CA
- **`aggregated-de-only.txt`** - 21,002 IPs from DE
- **`aggregated-gb-only.txt`** - 16,169 IPs from GB
- **`aggregated-kr-only.txt`** - 6,564 IPs from KR
- **`aggregated-us-only.txt`** - 79,868 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 145,346 unique IPs (deduplicated across all countries)
