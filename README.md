...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-438570-2D56A8)
...
- **`aggregated.txt`** - 438,570 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 11,133 IPs from AU
- **`aggregated-ca-only.txt`** - 11,365 IPs from CA
- **`aggregated-de-only.txt`** - 23,522 IPs from DE
- **`aggregated-gb-only.txt`** - 16,149 IPs from GB
- **`aggregated-kr-only.txt`** - 6,124 IPs from KR
- **`aggregated-us-only.txt`** - 83,784 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 152,077 unique IPs (deduplicated across all countries)
