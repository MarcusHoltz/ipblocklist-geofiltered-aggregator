...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-474726-2D56A8)
...
- **`aggregated.txt`** - 474,726 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,625 IPs from AU
- **`aggregated-ca-only.txt`** - 8,501 IPs from CA
- **`aggregated-de-only.txt`** - 14,753 IPs from DE
- **`aggregated-gb-only.txt`** - 8,793 IPs from GB
- **`aggregated-kr-only.txt`** - 6,241 IPs from KR
- **`aggregated-us-only.txt`** - 96,241 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 138,154 unique IPs (deduplicated across all countries)
