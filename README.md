...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-403671-2D56A8)
...
- **`aggregated.txt`** - 403,671 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,118 IPs from AU
- **`aggregated-ca-only.txt`** - 8,826 IPs from CA
- **`aggregated-de-only.txt`** - 15,008 IPs from DE
- **`aggregated-gb-only.txt`** - 8,430 IPs from GB
- **`aggregated-kr-only.txt`** - 10,919 IPs from KR
- **`aggregated-us-only.txt`** - 67,865 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 116,166 unique IPs (deduplicated across all countries)
