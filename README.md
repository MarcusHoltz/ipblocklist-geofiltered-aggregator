...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-459440-2D56A8)
...
**Last Updated:** 2025-11-05 03:29:49 UTC
...
- **Total Input IPs:** 459,440
- **Countries Processed:** 6
- **Combined Unique IPs:** 121,596
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 26.47%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 231,913 | 228,631 | 70,248 | 15.29% | `aggregated-us-only.txt` |
| Canada | CA | 18,016 | 17,895 | 9,862 | 2.15% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,513 | 33,361 | 9,336 | 2.03% | `aggregated-gb-only.txt` |
| Australia | AU | 11,668 | 11,599 | 4,129 | 0.90% | `aggregated-au-only.txt` |
| Germany | DE | 28,153 | 28,044 | 16,004 | 3.48% | `aggregated-de-only.txt` |
| South Korea | KR | 4,075 | 4,074 | 12,017 | 2.62% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 459,440 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,129 IPs from AU
- **`aggregated-ca-only.txt`** - 9,862 IPs from CA
- **`aggregated-de-only.txt`** - 16,004 IPs from DE
- **`aggregated-gb-only.txt`** - 9,336 IPs from GB
- **`aggregated-kr-only.txt`** - 12,017 IPs from KR
- **`aggregated-us-only.txt`** - 70,248 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,596 unique IPs (deduplicated across all countries)
