...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-508395-2D56A8)
...
**Last Updated:** 2025-10-17 14:38:12 UTC
...
- **Total Input IPs:** 508,395
- **Countries Processed:** 6
- **Combined Unique IPs:** 124,177
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 24.43%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 227,690 | 225,148 | 70,680 | 13.90% | `aggregated-us-only.txt` |
| Canada | CA | 17,925 | 17,808 | 10,449 | 2.06% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,170 | 33,025 | 9,563 | 1.88% | `aggregated-gb-only.txt` |
| Australia | AU | 11,608 | 11,551 | 4,268 | 0.84% | `aggregated-au-only.txt` |
| Germany | DE | 27,833 | 27,710 | 16,853 | 3.31% | `aggregated-de-only.txt` |
| South Korea | KR | 4,022 | 4,021 | 12,364 | 2.43% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 508,395 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,268 IPs from AU
- **`aggregated-ca-only.txt`** - 10,449 IPs from CA
- **`aggregated-de-only.txt`** - 16,853 IPs from DE
- **`aggregated-gb-only.txt`** - 9,563 IPs from GB
- **`aggregated-kr-only.txt`** - 12,364 IPs from KR
- **`aggregated-us-only.txt`** - 70,680 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 124,177 unique IPs (deduplicated across all countries)
