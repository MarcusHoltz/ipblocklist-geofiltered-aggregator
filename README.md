...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-434571-2D56A8)
...
**Last Updated:** 2026-04-14 05:12:23 UTC
...
- **Total Input IPs:** 434,571
- **Countries Processed:** 6
- **Combined Unique IPs:** 135,359
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 31.15%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 174,297 | 172,744 | 74,759 | 17.20% | `aggregated-us-only.txt` |
| Canada | CA | 16,926 | 16,789 | 9,656 | 2.22% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,790 | 33,627 | 14,672 | 3.38% | `aggregated-gb-only.txt` |
| Australia | AU | 11,413 | 11,331 | 10,602 | 2.44% | `aggregated-au-only.txt` |
| Germany | DE | 28,732 | 28,618 | 19,522 | 4.49% | `aggregated-de-only.txt` |
| South Korea | KR | 4,047 | 4,037 | 6,148 | 1.41% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 434,571 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,602 IPs from AU
- **`aggregated-ca-only.txt`** - 9,656 IPs from CA
- **`aggregated-de-only.txt`** - 19,522 IPs from DE
- **`aggregated-gb-only.txt`** - 14,672 IPs from GB
- **`aggregated-kr-only.txt`** - 6,148 IPs from KR
- **`aggregated-us-only.txt`** - 74,759 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 135,359 unique IPs (deduplicated across all countries)
