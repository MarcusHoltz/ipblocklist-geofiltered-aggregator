...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-426572-2D56A8)
...
**Last Updated:** 2025-11-12 14:42:32 UTC
...
"United Kingdom" : 2.1
"Australia" : 1.0
"Other/Unfiltered" : 72.3
```

## Overall Summary

- **Total Input IPs:** 426,572
- **Countries Processed:** 6
- **Combined Unique IPs:** 118,346
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 27.74%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 215,951 | 213,355 | 68,854 | 16.14% | `aggregated-us-only.txt` |
| Canada | CA | 17,382 | 17,256 | 9,304 | 2.18% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,943 | 32,796 | 8,978 | 2.10% | `aggregated-gb-only.txt` |
| Australia | AU | 11,295 | 11,226 | 4,385 | 1.03% | `aggregated-au-only.txt` |
| Germany | DE | 27,415 | 27,308 | 15,473 | 3.63% | `aggregated-de-only.txt` |
| South Korea | KR | 4,057 | 4,056 | 11,352 | 2.66% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 426,572 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,385 IPs from AU
- **`aggregated-ca-only.txt`** - 9,304 IPs from CA
- **`aggregated-de-only.txt`** - 15,473 IPs from DE
- **`aggregated-gb-only.txt`** - 8,978 IPs from GB
- **`aggregated-kr-only.txt`** - 11,352 IPs from KR
- **`aggregated-us-only.txt`** - 68,854 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 118,346 unique IPs (deduplicated across all countries)
