...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-465272-2D56A8)
...
- **`aggregated.txt`** - 465,272 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,974 IPs from AU
- **`aggregated-ca-only.txt`** - 10,002 IPs from CA
- **`aggregated-de-only.txt`** - 16,225 IPs from DE
- **`aggregated-gb-only.txt`** - 9,218 IPs from GB
- **`aggregated-kr-only.txt`** - 12,022 IPs from KR
- **`aggregated-us-only.txt`** - 70,036 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,477 unique IPs (deduplicated across all countries)
