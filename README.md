...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-455250-2D56A8)
...
**Last Updated:** 2026-01-31 14:46:08 UTC
...
- **Total Input IPs:** 455,250
- **Countries Processed:** 6
- **Combined Unique IPs:** 138,700
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 30.47%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 191,318 | 189,710 | 83,584 | 18.36% | `aggregated-us-only.txt` |
| Canada | CA | 17,196 | 17,071 | 11,160 | 2.45% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,750 | 33,592 | 11,786 | 2.59% | `aggregated-gb-only.txt` |
| Australia | AU | 11,508 | 11,442 | 5,871 | 1.29% | `aggregated-au-only.txt` |
| Germany | DE | 27,570 | 27,449 | 17,711 | 3.89% | `aggregated-de-only.txt` |
| South Korea | KR | 3,997 | 3,983 | 8,588 | 1.89% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 455,250 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,871 IPs from AU
- **`aggregated-ca-only.txt`** - 11,160 IPs from CA
- **`aggregated-de-only.txt`** - 17,711 IPs from DE
- **`aggregated-gb-only.txt`** - 11,786 IPs from GB
- **`aggregated-kr-only.txt`** - 8,588 IPs from KR
- **`aggregated-us-only.txt`** - 83,584 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 138,700 unique IPs (deduplicated across all countries)
