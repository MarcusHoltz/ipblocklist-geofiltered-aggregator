...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-549376-2D56A8)
...
- **`aggregated.txt`** - 549,376 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,698 IPs from AU
- **`aggregated-ca-only.txt`** - 11,117 IPs from CA
- **`aggregated-de-only.txt`** - 18,083 IPs from DE
- **`aggregated-gb-only.txt`** - 9,490 IPs from GB
- **`aggregated-kr-only.txt`** - 13,034 IPs from KR
- **`aggregated-us-only.txt`** - 73,428 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,850 unique IPs (deduplicated across all countries)
