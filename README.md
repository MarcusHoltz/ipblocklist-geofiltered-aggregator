...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-465775-2D56A8)
...
**Last Updated:** 2025-10-30 03:29:20 UTC
...
- **Total Input IPs:** 465,775
- **Countries Processed:** 6
- **Combined Unique IPs:** 121,306
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 26.04%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 230,975 | 227,909 | 70,264 | 15.09% | `aggregated-us-only.txt` |
| Canada | CA | 18,037 | 17,920 | 10,039 | 2.16% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,449 | 33,304 | 9,139 | 1.96% | `aggregated-gb-only.txt` |
| Australia | AU | 11,593 | 11,524 | 3,954 | 0.85% | `aggregated-au-only.txt` |
| Germany | DE | 27,871 | 27,768 | 16,182 | 3.47% | `aggregated-de-only.txt` |
| South Korea | KR | 4,035 | 4,034 | 11,728 | 2.52% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 465,775 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,954 IPs from AU
- **`aggregated-ca-only.txt`** - 10,039 IPs from CA
- **`aggregated-de-only.txt`** - 16,182 IPs from DE
- **`aggregated-gb-only.txt`** - 9,139 IPs from GB
- **`aggregated-kr-only.txt`** - 11,728 IPs from KR
- **`aggregated-us-only.txt`** - 70,264 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,306 unique IPs (deduplicated across all countries)
