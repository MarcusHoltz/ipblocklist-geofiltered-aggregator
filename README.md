...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-436062-2D56A8)
...
**Last Updated:** 2026-04-05 14:56:45 UTC
...
- **Total Input IPs:** 436,062
- **Countries Processed:** 6
- **Combined Unique IPs:** 136,416
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 178,007 | 176,418 | 75,897 | 17.41% | `aggregated-us-only.txt` |
| Canada | CA | 17,099 | 16,965 | 9,482 | 2.17% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 34,704 | 34,521 | 14,558 | 3.34% | `aggregated-gb-only.txt` |
| Australia | AU | 11,516 | 11,432 | 10,560 | 2.42% | `aggregated-au-only.txt` |
| Germany | DE | 29,921 | 29,834 | 19,559 | 4.49% | `aggregated-de-only.txt` |
| South Korea | KR | 4,103 | 4,093 | 6,360 | 1.46% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 436,062 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,560 IPs from AU
- **`aggregated-ca-only.txt`** - 9,482 IPs from CA
- **`aggregated-de-only.txt`** - 19,559 IPs from DE
- **`aggregated-gb-only.txt`** - 14,558 IPs from GB
- **`aggregated-kr-only.txt`** - 6,360 IPs from KR
- **`aggregated-us-only.txt`** - 75,897 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 136,416 unique IPs (deduplicated across all countries)
