...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-474158-2D56A8)
...
- **`aggregated.txt`** - 474,158 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,644 IPs from AU
- **`aggregated-ca-only.txt`** - 7,785 IPs from CA
- **`aggregated-de-only.txt`** - 14,721 IPs from DE
- **`aggregated-gb-only.txt`** - 8,624 IPs from GB
- **`aggregated-kr-only.txt`** - 6,300 IPs from KR
- **`aggregated-us-only.txt`** - 98,911 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 139,985 unique IPs (deduplicated across all countries)
