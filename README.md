...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-427280-2D56A8)
...
**Last Updated:** 2025-11-13 03:33:12 UTC
...
- **Total Input IPs:** 427,280
- **Countries Processed:** 6
- **Combined Unique IPs:** 118,671
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 27.77%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 215,951 | 213,355 | 69,012 | 16.15% | `aggregated-us-only.txt` |
| Canada | CA | 17,382 | 17,256 | 9,332 | 2.18% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,943 | 32,796 | 9,011 | 2.11% | `aggregated-gb-only.txt` |
| Australia | AU | 11,295 | 11,226 | 4,430 | 1.04% | `aggregated-au-only.txt` |
| Germany | DE | 27,415 | 27,308 | 15,527 | 3.63% | `aggregated-de-only.txt` |
...
- **`aggregated.txt`** - 427,280 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,430 IPs from AU
- **`aggregated-ca-only.txt`** - 9,332 IPs from CA
- **`aggregated-de-only.txt`** - 15,527 IPs from DE
- **`aggregated-gb-only.txt`** - 9,011 IPs from GB
- **`aggregated-kr-only.txt`** - 11,359 IPs from KR
- **`aggregated-us-only.txt`** - 69,012 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 118,671 unique IPs (deduplicated across all countries)
