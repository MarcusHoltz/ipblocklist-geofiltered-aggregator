...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-436319-2D56A8)
...
**Last Updated:** 2026-06-15 18:48:47 UTC
...
- **Total Input IPs:** 436,319
- **Countries Processed:** 6
- **Combined Unique IPs:** 152,400
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 162,102 | 160,287 | 83,339 | 19.10% | `aggregated-us-only.txt` |
| Canada | CA | 16,986 | 16,858 | 12,067 | 2.77% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,600 | 35,425 | 15,976 | 3.66% | `aggregated-gb-only.txt` |
| Australia | AU | 12,043 | 11,960 | 11,103 | 2.54% | `aggregated-au-only.txt` |
| Germany | DE | 28,808 | 28,728 | 24,056 | 5.51% | `aggregated-de-only.txt` |
| South Korea | KR | 3,954 | 3,944 | 5,859 | 1.34% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 436,319 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 11,103 IPs from AU
- **`aggregated-ca-only.txt`** - 12,067 IPs from CA
- **`aggregated-de-only.txt`** - 24,056 IPs from DE
- **`aggregated-gb-only.txt`** - 15,976 IPs from GB
- **`aggregated-kr-only.txt`** - 5,859 IPs from KR
- **`aggregated-us-only.txt`** - 83,339 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 152,400 unique IPs (deduplicated across all countries)
