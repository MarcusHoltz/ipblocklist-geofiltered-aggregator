...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-428142-2D56A8)
...
**Last Updated:** 2026-03-27 04:43:47 UTC
...
- **Total Input IPs:** 428,142
- **Countries Processed:** 6
- **Combined Unique IPs:** 136,674
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 31.92%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 181,809 | 180,208 | 75,860 | 17.72% | `aggregated-us-only.txt` |
| Canada | CA | 16,866 | 16,741 | 9,832 | 2.30% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,693 | 33,508 | 14,711 | 3.44% | `aggregated-gb-only.txt` |
| Australia | AU | 11,441 | 11,360 | 10,575 | 2.47% | `aggregated-au-only.txt` |
| Germany | DE | 28,381 | 28,291 | 19,166 | 4.48% | `aggregated-de-only.txt` |
| South Korea | KR | 4,031 | 4,020 | 6,530 | 1.53% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 428,142 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,575 IPs from AU
- **`aggregated-ca-only.txt`** - 9,832 IPs from CA
- **`aggregated-de-only.txt`** - 19,166 IPs from DE
- **`aggregated-gb-only.txt`** - 14,711 IPs from GB
- **`aggregated-kr-only.txt`** - 6,530 IPs from KR
- **`aggregated-us-only.txt`** - 75,860 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 136,674 unique IPs (deduplicated across all countries)
