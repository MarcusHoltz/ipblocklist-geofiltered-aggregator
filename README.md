...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-448110-2D56A8)
...
**Last Updated:** 2026-08-09 03:55:31 UTC
...
- **Total Input IPs:** 448,110
- **Countries Processed:** 6
- **Combined Unique IPs:** 125,562
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 28.02%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 133,752 | 131,895 | 81,077 | 18.09% | `aggregated-us-only.txt` |
| Canada | CA | 17,090 | 16,967 | 7,801 | 1.74% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,611 | 35,465 | 8,408 | 1.88% | `aggregated-gb-only.txt` |
| Australia | AU | 12,166 | 12,097 | 5,100 | 1.14% | `aggregated-au-only.txt` |
| Germany | DE | 29,554 | 29,487 | 16,963 | 3.79% | `aggregated-de-only.txt` |
| South Korea | KR | 3,940 | 3,930 | 6,213 | 1.39% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 448,110 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,100 IPs from AU
- **`aggregated-ca-only.txt`** - 7,801 IPs from CA
- **`aggregated-de-only.txt`** - 16,963 IPs from DE
- **`aggregated-gb-only.txt`** - 8,408 IPs from GB
- **`aggregated-kr-only.txt`** - 6,213 IPs from KR
- **`aggregated-us-only.txt`** - 81,077 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 125,562 unique IPs (deduplicated across all countries)
