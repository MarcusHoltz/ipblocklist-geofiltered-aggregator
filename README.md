...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-475250-2D56A8)
...
**Last Updated:** 2026-09-04 17:40:10 UTC
...
- **Total Input IPs:** 475,250
- **Countries Processed:** 6
- **Combined Unique IPs:** 140,445
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 29.55%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,784 | 128,927 | 99,223 | 20.88% | `aggregated-us-only.txt` |
| Canada | CA | 17,155 | 17,039 | 7,843 | 1.65% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,780 | 35,619 | 8,777 | 1.85% | `aggregated-gb-only.txt` |
| Australia | AU | 12,241 | 12,174 | 3,608 | 0.76% | `aggregated-au-only.txt` |
| Germany | DE | 29,886 | 29,769 | 14,709 | 3.10% | `aggregated-de-only.txt` |
| South Korea | KR | 3,921 | 3,910 | 6,285 | 1.32% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 475,250 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,608 IPs from AU
- **`aggregated-ca-only.txt`** - 7,843 IPs from CA
- **`aggregated-de-only.txt`** - 14,709 IPs from DE
- **`aggregated-gb-only.txt`** - 8,777 IPs from GB
- **`aggregated-kr-only.txt`** - 6,285 IPs from KR
- **`aggregated-us-only.txt`** - 99,223 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 140,445 unique IPs (deduplicated across all countries)
