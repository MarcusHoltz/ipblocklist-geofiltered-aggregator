...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-416691-2D56A8)
...
**Last Updated:** 2026-03-14 14:50:14 UTC
...
- **Total Input IPs:** 416,691
- **Countries Processed:** 6
- **Combined Unique IPs:** 135,795
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 32.59%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 182,708 | 181,071 | 77,540 | 18.61% | `aggregated-us-only.txt` |
| Canada | CA | 16,787 | 16,659 | 9,432 | 2.26% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 34,352 | 34,165 | 13,895 | 3.33% | `aggregated-gb-only.txt` |
| Australia | AU | 11,350 | 11,275 | 10,162 | 2.44% | `aggregated-au-only.txt` |
| Germany | DE | 28,411 | 28,332 | 18,244 | 4.38% | `aggregated-de-only.txt` |
| South Korea | KR | 4,030 | 4,029 | 6,522 | 1.57% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 416,691 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,162 IPs from AU
- **`aggregated-ca-only.txt`** - 9,432 IPs from CA
- **`aggregated-de-only.txt`** - 18,244 IPs from DE
- **`aggregated-gb-only.txt`** - 13,895 IPs from GB
- **`aggregated-kr-only.txt`** - 6,522 IPs from KR
- **`aggregated-us-only.txt`** - 77,540 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 135,795 unique IPs (deduplicated across all countries)
