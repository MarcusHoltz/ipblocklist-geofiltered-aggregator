...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-599419-2D56A8)
...
**Last Updated:** 2025-09-08 14:39:45 UTC
...
- **Total Input IPs:** 599,419
- **Countries Processed:** 6
- **Combined Unique IPs:** 135,668
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 221,782 | 219,407 | 75,707 | 12.63% | `aggregated-us-only.txt` |
| Canada | CA | 17,528 | 17,415 | 11,609 | 1.94% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,235 | 32,074 | 9,990 | 1.67% | `aggregated-gb-only.txt` |
| Australia | AU | 11,462 | 11,404 | 4,873 | 0.81% | `aggregated-au-only.txt` |
| Germany | DE | 27,414 | 27,292 | 19,840 | 3.31% | `aggregated-de-only.txt` |
| South Korea | KR | 3,962 | 3,949 | 13,649 | 2.28% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 599,419 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,873 IPs from AU
- **`aggregated-ca-only.txt`** - 11,609 IPs from CA
- **`aggregated-de-only.txt`** - 19,840 IPs from DE
- **`aggregated-gb-only.txt`** - 9,990 IPs from GB
- **`aggregated-kr-only.txt`** - 13,649 IPs from KR
- **`aggregated-us-only.txt`** - 75,707 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 135,668 unique IPs (deduplicated across all countries)
