...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-733396-2D56A8)
...
**Last Updated:** 2026-09-24 18:30:40 UTC
...
- **Total Input IPs:** 733,396
- **Countries Processed:** 6
- **Combined Unique IPs:** 215,607
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 128,919 | 127,081 | 151,866 | 20.71% | `aggregated-us-only.txt` |
| Canada | CA | 17,281 | 17,163 | 11,651 | 1.59% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 36,037 | 35,862 | 14,088 | 1.92% | `aggregated-gb-only.txt` |
| Australia | AU | 12,686 | 12,614 | 5,365 | 0.73% | `aggregated-au-only.txt` |
| Germany | DE | 29,692 | 29,583 | 22,029 | 3.00% | `aggregated-de-only.txt` |
| South Korea | KR | 3,953 | 3,919 | 10,608 | 1.45% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 733,396 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,365 IPs from AU
- **`aggregated-ca-only.txt`** - 11,651 IPs from CA
- **`aggregated-de-only.txt`** - 22,029 IPs from DE
- **`aggregated-gb-only.txt`** - 14,088 IPs from GB
- **`aggregated-kr-only.txt`** - 10,608 IPs from KR
- **`aggregated-us-only.txt`** - 151,866 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 215,607 unique IPs (deduplicated across all countries)
