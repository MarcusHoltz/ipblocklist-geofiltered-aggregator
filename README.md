...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-407264-2D56A8)
...
**Last Updated:** 2025-11-22 14:33:25 UTC
...
- **Total Input IPs:** 407,264
- **Countries Processed:** 6
- **Combined Unique IPs:** 116,864
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 213,082 | 211,660 | 68,388 | 16.79% | `aggregated-us-only.txt` |
| Canada | CA | 17,510 | 17,389 | 8,863 | 2.18% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,226 | 33,096 | 8,451 | 2.08% | `aggregated-gb-only.txt` |
| Australia | AU | 11,247 | 11,177 | 5,134 | 1.26% | `aggregated-au-only.txt` |
| Germany | DE | 27,310 | 27,183 | 15,050 | 3.70% | `aggregated-de-only.txt` |
| South Korea | KR | 4,040 | 4,039 | 10,978 | 2.70% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 407,264 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,134 IPs from AU
- **`aggregated-ca-only.txt`** - 8,863 IPs from CA
- **`aggregated-de-only.txt`** - 15,050 IPs from DE
- **`aggregated-gb-only.txt`** - 8,451 IPs from GB
- **`aggregated-kr-only.txt`** - 10,978 IPs from KR
- **`aggregated-us-only.txt`** - 68,388 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 116,864 unique IPs (deduplicated across all countries)
