...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-433195-2D56A8)
...
- **`aggregated.txt`** - 433,195 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,171 IPs from AU
- **`aggregated-ca-only.txt`** - 10,295 IPs from CA
- **`aggregated-de-only.txt`** - 20,840 IPs from DE
- **`aggregated-gb-only.txt`** - 13,941 IPs from GB
- **`aggregated-kr-only.txt`** - 6,287 IPs from KR
- **`aggregated-us-only.txt`** - 79,467 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 141,001 unique IPs (deduplicated across all countries)
