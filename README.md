...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-443775-2D56A8)
...
- **`aggregated.txt`** - 443,775 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 9,716 IPs from AU
- **`aggregated-ca-only.txt`** - 10,071 IPs from CA
- **`aggregated-de-only.txt`** - 21,454 IPs from DE
- **`aggregated-gb-only.txt`** - 13,350 IPs from GB
- **`aggregated-kr-only.txt`** - 6,220 IPs from KR
- **`aggregated-us-only.txt`** - 79,281 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 140,092 unique IPs (deduplicated across all countries)
