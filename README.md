...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-401381-2D56A8)
...
**Last Updated:** 2025-12-06 14:34:06 UTC
...
- **Total Input IPs:** 401,381
- **Countries Processed:** 6
- **Combined Unique IPs:** 121,744
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 208,627 | 207,128 | 72,389 | 18.03% | `aggregated-us-only.txt` |
| Canada | CA | 17,397 | 17,271 | 8,558 | 2.13% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,084 | 32,951 | 9,085 | 2.26% | `aggregated-gb-only.txt` |
| Australia | AU | 11,257 | 11,196 | 5,442 | 1.36% | `aggregated-au-only.txt` |
| Germany | DE | 27,412 | 27,288 | 15,081 | 3.76% | `aggregated-de-only.txt` |
| South Korea | KR | 4,016 | 4,015 | 11,189 | 2.79% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 401,381 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,442 IPs from AU
- **`aggregated-ca-only.txt`** - 8,558 IPs from CA
- **`aggregated-de-only.txt`** - 15,081 IPs from DE
- **`aggregated-gb-only.txt`** - 9,085 IPs from GB
- **`aggregated-kr-only.txt`** - 11,189 IPs from KR
- **`aggregated-us-only.txt`** - 72,389 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,744 unique IPs (deduplicated across all countries)
