...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-574732-2D56A8)
...
**Last Updated:** 2025-09-22 03:16:34 UTC
...
- **Total Input IPs:** 574,732
- **Countries Processed:** 6
- **Combined Unique IPs:** 133,770
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.28%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 224,791 | 222,401 | 74,690 | 13.00% | `aggregated-us-only.txt` |
| Canada | CA | 17,886 | 17,771 | 11,450 | 1.99% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,808 | 32,653 | 9,557 | 1.66% | `aggregated-gb-only.txt` |
| Australia | AU | 11,669 | 11,610 | 4,845 | 0.84% | `aggregated-au-only.txt` |
| Germany | DE | 27,582 | 27,471 | 19,793 | 3.44% | `aggregated-de-only.txt` |
| South Korea | KR | 4,009 | 4,008 | 13,435 | 2.34% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 574,732 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,845 IPs from AU
- **`aggregated-ca-only.txt`** - 11,450 IPs from CA
- **`aggregated-de-only.txt`** - 19,793 IPs from DE
- **`aggregated-gb-only.txt`** - 9,557 IPs from GB
- **`aggregated-kr-only.txt`** - 13,435 IPs from KR
- **`aggregated-us-only.txt`** - 74,690 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 133,770 unique IPs (deduplicated across all countries)
