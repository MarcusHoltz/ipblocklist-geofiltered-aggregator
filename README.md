...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-450218-2D56A8)
...
**Last Updated:** 2026-01-29 15:02:33 UTC
...
- **Total Input IPs:** 450,218
- **Countries Processed:** 6
- **Combined Unique IPs:** 137,253
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 191,318 | 189,710 | 82,644 | 18.36% | `aggregated-us-only.txt` |
| Canada | CA | 17,196 | 17,071 | 11,081 | 2.46% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,750 | 33,592 | 11,644 | 2.59% | `aggregated-gb-only.txt` |
| Australia | AU | 11,508 | 11,442 | 5,802 | 1.29% | `aggregated-au-only.txt` |
| Germany | DE | 27,570 | 27,449 | 17,512 | 3.89% | `aggregated-de-only.txt` |
| South Korea | KR | 3,997 | 3,983 | 8,570 | 1.90% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 450,218 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,802 IPs from AU
- **`aggregated-ca-only.txt`** - 11,081 IPs from CA
- **`aggregated-de-only.txt`** - 17,512 IPs from DE
- **`aggregated-gb-only.txt`** - 11,644 IPs from GB
- **`aggregated-kr-only.txt`** - 8,570 IPs from KR
- **`aggregated-us-only.txt`** - 82,644 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 137,253 unique IPs (deduplicated across all countries)
