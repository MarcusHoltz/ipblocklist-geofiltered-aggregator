...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-600477-2D56A8)
...
**Last Updated:** 2025-08-30 03:08:42 UTC
...
"United Kingdom" : 1.6
"Australia" : 0.8
"Other/Unfiltered" : 77.9
```

## Overall Summary

- **Total Input IPs:** 600,477
- **Countries Processed:** 6
- **Combined Unique IPs:** 132,799
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 22.12%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 218,244 | 216,816 | 74,972 | 12.49% | `aggregated-us-only.txt` |
| Canada | CA | 17,804 | 17,678 | 10,960 | 1.83% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,316 | 32,142 | 9,670 | 1.61% | `aggregated-gb-only.txt` |
| Australia | AU | 11,315 | 11,257 | 4,581 | 0.76% | `aggregated-au-only.txt` |
| Germany | DE | 27,285 | 27,176 | 19,298 | 3.21% | `aggregated-de-only.txt` |
| South Korea | KR | 3,946 | 3,933 | 13,318 | 2.22% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 600,477 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,581 IPs from AU
- **`aggregated-ca-only.txt`** - 10,960 IPs from CA
- **`aggregated-de-only.txt`** - 19,298 IPs from DE
- **`aggregated-gb-only.txt`** - 9,670 IPs from GB
- **`aggregated-kr-only.txt`** - 13,318 IPs from KR
- **`aggregated-us-only.txt`** - 74,972 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 132,799 unique IPs (deduplicated across all countries)
