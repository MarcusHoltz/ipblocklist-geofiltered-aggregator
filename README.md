...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-438540-2D56A8)
...
**Last Updated:** 2026-04-08 04:47:13 UTC
...
- **Total Input IPs:** 438,540
- **Countries Processed:** 6
- **Combined Unique IPs:** 135,820
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 30.97%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 178,007 | 176,418 | 75,331 | 17.18% | `aggregated-us-only.txt` |
| Canada | CA | 17,099 | 16,965 | 9,487 | 2.16% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 34,704 | 34,521 | 14,600 | 3.33% | `aggregated-gb-only.txt` |
| Australia | AU | 11,516 | 11,432 | 10,590 | 2.41% | `aggregated-au-only.txt` |
| Germany | DE | 29,921 | 29,834 | 19,529 | 4.45% | `aggregated-de-only.txt` |
| South Korea | KR | 4,103 | 4,093 | 6,283 | 1.43% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 438,540 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,590 IPs from AU
- **`aggregated-ca-only.txt`** - 9,487 IPs from CA
- **`aggregated-de-only.txt`** - 19,529 IPs from DE
- **`aggregated-gb-only.txt`** - 14,600 IPs from GB
- **`aggregated-kr-only.txt`** - 6,283 IPs from KR
- **`aggregated-us-only.txt`** - 75,331 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 135,820 unique IPs (deduplicated across all countries)
