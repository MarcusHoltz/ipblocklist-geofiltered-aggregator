...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-409548-2D56A8)
...
**Last Updated:** 2025-12-14 14:35:43 UTC
...
- **Total Input IPs:** 409,548
- **Countries Processed:** 6
- **Combined Unique IPs:** 124,557
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 205,029 | 203,447 | 74,318 | 18.15% | `aggregated-us-only.txt` |
| Canada | CA | 17,534 | 17,408 | 8,551 | 2.09% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,613 | 33,458 | 9,533 | 2.33% | `aggregated-gb-only.txt` |
| Australia | AU | 11,630 | 11,560 | 5,524 | 1.35% | `aggregated-au-only.txt` |
| Germany | DE | 27,435 | 27,295 | 15,813 | 3.86% | `aggregated-de-only.txt` |
| South Korea | KR | 3,986 | 3,985 | 10,818 | 2.64% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 409,548 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,524 IPs from AU
- **`aggregated-ca-only.txt`** - 8,551 IPs from CA
- **`aggregated-de-only.txt`** - 15,813 IPs from DE
- **`aggregated-gb-only.txt`** - 9,533 IPs from GB
- **`aggregated-kr-only.txt`** - 10,818 IPs from KR
- **`aggregated-us-only.txt`** - 74,318 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 124,557 unique IPs (deduplicated across all countries)
