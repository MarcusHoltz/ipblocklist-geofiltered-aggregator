...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-484189-2D56A8)
...
**Last Updated:** 2025-10-26 14:33:30 UTC
...
"United Kingdom" : 1.9
"Australia" : 0.8
"Other/Unfiltered" : 74.6
```

## Overall Summary

- **Total Input IPs:** 484,189
- **Countries Processed:** 6
- **Combined Unique IPs:** 122,874
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 25.38%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 230,975 | 227,909 | 70,743 | 14.61% | `aggregated-us-only.txt` |
| Canada | CA | 18,037 | 17,920 | 10,203 | 2.11% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,449 | 33,304 | 9,337 | 1.93% | `aggregated-gb-only.txt` |
| Australia | AU | 11,593 | 11,524 | 4,058 | 0.84% | `aggregated-au-only.txt` |
| Germany | DE | 27,871 | 27,768 | 16,537 | 3.42% | `aggregated-de-only.txt` |
| South Korea | KR | 4,035 | 4,034 | 11,996 | 2.48% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 484,189 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,058 IPs from AU
- **`aggregated-ca-only.txt`** - 10,203 IPs from CA
- **`aggregated-de-only.txt`** - 16,537 IPs from DE
- **`aggregated-gb-only.txt`** - 9,337 IPs from GB
- **`aggregated-kr-only.txt`** - 11,996 IPs from KR
- **`aggregated-us-only.txt`** - 70,743 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 122,874 unique IPs (deduplicated across all countries)
