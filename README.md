...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-475619-2D56A8)
...
**Last Updated:** 2026-09-03 17:55:09 UTC
...
- **Total Input IPs:** 475,619
- **Countries Processed:** 6
- **Combined Unique IPs:** 139,536
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 29.34%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,784 | 128,927 | 98,234 | 20.65% | `aggregated-us-only.txt` |
| Canada | CA | 17,155 | 17,039 | 7,824 | 1.65% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,780 | 35,619 | 8,838 | 1.86% | `aggregated-gb-only.txt` |
| Australia | AU | 12,241 | 12,174 | 3,609 | 0.76% | `aggregated-au-only.txt` |
| Germany | DE | 29,886 | 29,769 | 14,753 | 3.10% | `aggregated-de-only.txt` |
| South Korea | KR | 3,921 | 3,910 | 6,278 | 1.32% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 475,619 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,609 IPs from AU
- **`aggregated-ca-only.txt`** - 7,824 IPs from CA
- **`aggregated-de-only.txt`** - 14,753 IPs from DE
- **`aggregated-gb-only.txt`** - 8,838 IPs from GB
- **`aggregated-kr-only.txt`** - 6,278 IPs from KR
- **`aggregated-us-only.txt`** - 98,234 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 139,536 unique IPs (deduplicated across all countries)
