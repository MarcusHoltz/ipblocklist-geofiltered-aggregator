...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-467297-2D56A8)
...
**Last Updated:** 2025-10-30 14:40:34 UTC
...
- **Total Input IPs:** 467,297
- **Countries Processed:** 6
- **Combined Unique IPs:** 121,864
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 26.08%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 230,975 | 227,909 | 70,424 | 15.07% | `aggregated-us-only.txt` |
| Canada | CA | 18,037 | 17,920 | 10,101 | 2.16% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,449 | 33,304 | 9,207 | 1.97% | `aggregated-gb-only.txt` |
| Australia | AU | 11,593 | 11,524 | 3,980 | 0.85% | `aggregated-au-only.txt` |
| Germany | DE | 27,871 | 27,768 | 16,390 | 3.51% | `aggregated-de-only.txt` |
| South Korea | KR | 4,035 | 4,034 | 11,762 | 2.52% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 467,297 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,980 IPs from AU
- **`aggregated-ca-only.txt`** - 10,101 IPs from CA
- **`aggregated-de-only.txt`** - 16,390 IPs from DE
- **`aggregated-gb-only.txt`** - 9,207 IPs from GB
- **`aggregated-kr-only.txt`** - 11,762 IPs from KR
- **`aggregated-us-only.txt`** - 70,424 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 121,864 unique IPs (deduplicated across all countries)
