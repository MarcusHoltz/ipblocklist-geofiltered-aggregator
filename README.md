...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-473891-2D56A8)
...
**Last Updated:** 2026-01-21 14:53:52 UTC
...
- **Total Input IPs:** 473,891
- **Countries Processed:** 6
- **Combined Unique IPs:** 137,684
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 192,503 | 190,855 | 82,130 | 17.33% | `aggregated-us-only.txt` |
| Canada | CA | 17,317 | 17,192 | 10,609 | 2.24% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,656 | 33,494 | 11,758 | 2.48% | `aggregated-gb-only.txt` |
| Australia | AU | 11,536 | 11,469 | 5,777 | 1.22% | `aggregated-au-only.txt` |
| Germany | DE | 27,599 | 27,451 | 18,758 | 3.96% | `aggregated-de-only.txt` |
| South Korea | KR | 3,999 | 3,985 | 8,652 | 1.83% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 473,891 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,777 IPs from AU
- **`aggregated-ca-only.txt`** - 10,609 IPs from CA
- **`aggregated-de-only.txt`** - 18,758 IPs from DE
- **`aggregated-gb-only.txt`** - 11,758 IPs from GB
- **`aggregated-kr-only.txt`** - 8,652 IPs from KR
- **`aggregated-us-only.txt`** - 82,130 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 137,684 unique IPs (deduplicated across all countries)
