...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-377175-2D56A8)
...
**Last Updated:** 2026-02-23 15:10:01 UTC
...
- **Total Input IPs:** 377,175
- **Countries Processed:** 6
- **Combined Unique IPs:** 119,470
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 31.67%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 187,140 | 185,523 | 72,771 | 19.29% | `aggregated-us-only.txt` |
| Canada | CA | 16,884 | 16,753 | 8,584 | 2.28% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,109 | 32,941 | 9,137 | 2.42% | `aggregated-gb-only.txt` |
| Australia | AU | 11,405 | 11,339 | 6,597 | 1.75% | `aggregated-au-only.txt` |
| Germany | DE | 28,130 | 28,030 | 15,567 | 4.13% | `aggregated-de-only.txt` |
| South Korea | KR | 4,020 | 4,019 | 6,814 | 1.81% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 377,175 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 6,597 IPs from AU
- **`aggregated-ca-only.txt`** - 8,584 IPs from CA
- **`aggregated-de-only.txt`** - 15,567 IPs from DE
- **`aggregated-gb-only.txt`** - 9,137 IPs from GB
- **`aggregated-kr-only.txt`** - 6,814 IPs from KR
- **`aggregated-us-only.txt`** - 72,771 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 119,470 unique IPs (deduplicated across all countries)
