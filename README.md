...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-605873-2D56A8)
...
- **`aggregated.txt`** - 605,873 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,585 IPs from AU
- **`aggregated-ca-only.txt`** - 10,616 IPs from CA
- **`aggregated-de-only.txt`** - 19,224 IPs from DE
- **`aggregated-gb-only.txt`** - 9,786 IPs from GB
- **`aggregated-kr-only.txt`** - 13,276 IPs from KR
- **`aggregated-us-only.txt`** - 74,123 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 131,610 unique IPs (deduplicated across all countries)
