...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-511253-2D56A8)
...
**Last Updated:** 2025-10-15 14:41:56 UTC
...
"United Kingdom" : 1.9
"Australia" : 0.8
"Other/Unfiltered" : 75.9
```

## Overall Summary

- **Total Input IPs:** 511,253
- **Countries Processed:** 6
- **Combined Unique IPs:** 123,449
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 24.15%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 227,690 | 225,148 | 69,966 | 13.69% | `aggregated-us-only.txt` |
| Canada | CA | 17,925 | 17,808 | 10,454 | 2.04% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,170 | 33,025 | 9,460 | 1.85% | `aggregated-gb-only.txt` |
| Australia | AU | 11,608 | 11,551 | 4,270 | 0.84% | `aggregated-au-only.txt` |
| Germany | DE | 27,833 | 27,710 | 16,930 | 3.31% | `aggregated-de-only.txt` |
...
- **`aggregated.txt`** - 511,253 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,270 IPs from AU
- **`aggregated-ca-only.txt`** - 10,454 IPs from CA
- **`aggregated-de-only.txt`** - 16,930 IPs from DE
- **`aggregated-gb-only.txt`** - 9,460 IPs from GB
- **`aggregated-kr-only.txt`** - 12,369 IPs from KR
- **`aggregated-us-only.txt`** - 69,966 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,449 unique IPs (deduplicated across all countries)
