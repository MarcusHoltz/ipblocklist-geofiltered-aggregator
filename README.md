...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-435112-2D56A8)
...
- **`aggregated.txt`** - 435,112 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 11,093 IPs from AU
- **`aggregated-ca-only.txt`** - 12,103 IPs from CA
- **`aggregated-de-only.txt`** - 23,927 IPs from DE
- **`aggregated-gb-only.txt`** - 15,935 IPs from GB
- **`aggregated-kr-only.txt`** - 5,879 IPs from KR
- **`aggregated-us-only.txt`** - 82,969 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 151,906 unique IPs (deduplicated across all countries)
