...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-431555-2D56A8)
...
**Last Updated:** 2026-03-28 04:30:56 UTC
...
- **Total Input IPs:** 431,555
- **Countries Processed:** 6
- **Combined Unique IPs:** 136,174
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 31.55%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 181,809 | 180,208 | 75,448 | 17.48% | `aggregated-us-only.txt` |
| Canada | CA | 16,866 | 16,741 | 9,705 | 2.25% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,693 | 33,508 | 14,754 | 3.42% | `aggregated-gb-only.txt` |
| Australia | AU | 11,441 | 11,360 | 10,549 | 2.44% | `aggregated-au-only.txt` |
| Germany | DE | 28,381 | 28,291 | 19,183 | 4.45% | `aggregated-de-only.txt` |
| South Korea | KR | 4,031 | 4,020 | 6,535 | 1.51% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 431,555 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,549 IPs from AU
- **`aggregated-ca-only.txt`** - 9,705 IPs from CA
- **`aggregated-de-only.txt`** - 19,183 IPs from DE
- **`aggregated-gb-only.txt`** - 14,754 IPs from GB
- **`aggregated-kr-only.txt`** - 6,535 IPs from KR
- **`aggregated-us-only.txt`** - 75,448 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 136,174 unique IPs (deduplicated across all countries)
