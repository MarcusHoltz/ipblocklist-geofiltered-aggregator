...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-602759-2D56A8)
...
**Last Updated:** 2025-09-04 03:06:02 UTC
...
- **Total Input IPs:** 602,759
- **Countries Processed:** 6
- **Combined Unique IPs:** 136,038
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 220,451 | 218,516 | 76,331 | 12.66% | `aggregated-us-only.txt` |
| Canada | CA | 17,656 | 17,532 | 11,501 | 1.91% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,222 | 32,048 | 10,016 | 1.66% | `aggregated-gb-only.txt` |
| Australia | AU | 11,427 | 11,369 | 4,888 | 0.81% | `aggregated-au-only.txt` |
| Germany | DE | 27,379 | 27,270 | 19,691 | 3.27% | `aggregated-de-only.txt` |
| South Korea | KR | 3,959 | 3,946 | 13,611 | 2.26% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 602,759 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,888 IPs from AU
- **`aggregated-ca-only.txt`** - 11,501 IPs from CA
- **`aggregated-de-only.txt`** - 19,691 IPs from DE
- **`aggregated-gb-only.txt`** - 10,016 IPs from GB
- **`aggregated-kr-only.txt`** - 13,611 IPs from KR
- **`aggregated-us-only.txt`** - 76,331 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 136,038 unique IPs (deduplicated across all countries)
