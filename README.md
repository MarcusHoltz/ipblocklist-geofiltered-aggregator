...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-601163-2D56A8)
...
**Last Updated:** 2025-09-14 14:31:19 UTC
...
- **Total Input IPs:** 601,163
- **Countries Processed:** 6
- **Combined Unique IPs:** 137,237
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 22.83%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 223,146 | 220,769 | 76,610 | 12.74% | `aggregated-us-only.txt` |
| Canada | CA | 17,802 | 17,689 | 11,905 | 1.98% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,651 | 32,492 | 10,152 | 1.69% | `aggregated-gb-only.txt` |
| Australia | AU | 11,651 | 11,596 | 4,909 | 0.82% | `aggregated-au-only.txt` |
| Germany | DE | 27,507 | 27,398 | 20,067 | 3.34% | `aggregated-de-only.txt` |
| South Korea | KR | 3,948 | 3,947 | 13,594 | 2.26% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 601,163 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,909 IPs from AU
- **`aggregated-ca-only.txt`** - 11,905 IPs from CA
- **`aggregated-de-only.txt`** - 20,067 IPs from DE
- **`aggregated-gb-only.txt`** - 10,152 IPs from GB
- **`aggregated-kr-only.txt`** - 13,594 IPs from KR
- **`aggregated-us-only.txt`** - 76,610 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 137,237 unique IPs (deduplicated across all countries)
