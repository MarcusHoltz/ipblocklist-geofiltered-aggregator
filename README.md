...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-458942-2D56A8)
...
- **`aggregated.txt`** - 458,942 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,969 IPs from AU
- **`aggregated-ca-only.txt`** - 7,953 IPs from CA
- **`aggregated-de-only.txt`** - 16,960 IPs from DE
- **`aggregated-gb-only.txt`** - 8,716 IPs from GB
- **`aggregated-kr-only.txt`** - 6,309 IPs from KR
- **`aggregated-us-only.txt`** - 84,305 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,212 unique IPs (deduplicated across all countries)
