...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-445418-2D56A8)
...
**Last Updated:** 2026-07-24 15:47:58 UTC
...
- **Total Input IPs:** 445,418
- **Countries Processed:** 6
- **Combined Unique IPs:** 131,089
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 29.43%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 137,787 | 135,973 | 78,844 | 17.70% | `aggregated-us-only.txt` |
| Canada | CA | 16,857 | 16,741 | 9,532 | 2.14% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,446 | 35,279 | 10,145 | 2.28% | `aggregated-gb-only.txt` |
| Australia | AU | 12,109 | 12,038 | 6,396 | 1.44% | `aggregated-au-only.txt` |
| Germany | DE | 29,153 | 29,083 | 19,771 | 4.44% | `aggregated-de-only.txt` |
| South Korea | KR | 3,909 | 3,899 | 6,401 | 1.44% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 445,418 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 6,396 IPs from AU
- **`aggregated-ca-only.txt`** - 9,532 IPs from CA
- **`aggregated-de-only.txt`** - 19,771 IPs from DE
- **`aggregated-gb-only.txt`** - 10,145 IPs from GB
- **`aggregated-kr-only.txt`** - 6,401 IPs from KR
- **`aggregated-us-only.txt`** - 78,844 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 131,089 unique IPs (deduplicated across all countries)
