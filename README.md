...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-461296-2D56A8)
...
**Last Updated:** 2026-01-25 04:03:12 UTC
...
- **Total Input IPs:** 461,296
- **Countries Processed:** 6
- **Combined Unique IPs:** 137,833
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 29.88%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 191,318 | 189,710 | 81,397 | 17.65% | `aggregated-us-only.txt` |
| Canada | CA | 17,196 | 17,071 | 11,652 | 2.53% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,750 | 33,592 | 11,707 | 2.54% | `aggregated-gb-only.txt` |
| Australia | AU | 11,508 | 11,442 | 5,747 | 1.25% | `aggregated-au-only.txt` |
| Germany | DE | 27,570 | 27,449 | 18,756 | 4.07% | `aggregated-de-only.txt` |
| South Korea | KR | 3,997 | 3,983 | 8,574 | 1.86% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 461,296 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,747 IPs from AU
- **`aggregated-ca-only.txt`** - 11,652 IPs from CA
- **`aggregated-de-only.txt`** - 18,756 IPs from DE
- **`aggregated-gb-only.txt`** - 11,707 IPs from GB
- **`aggregated-kr-only.txt`** - 8,574 IPs from KR
- **`aggregated-us-only.txt`** - 81,397 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 137,833 unique IPs (deduplicated across all countries)
