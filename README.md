...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-601891-2D56A8)
...
**Last Updated:** 2025-09-10 14:35:45 UTC
...
- **Total Input IPs:** 601,891
- **Countries Processed:** 6
- **Combined Unique IPs:** 136,081
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 22.61%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 221,782 | 219,407 | 75,721 | 12.58% | `aggregated-us-only.txt` |
| Canada | CA | 17,528 | 17,415 | 11,705 | 1.94% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,235 | 32,074 | 10,076 | 1.67% | `aggregated-gb-only.txt` |
| Australia | AU | 11,462 | 11,404 | 4,895 | 0.81% | `aggregated-au-only.txt` |
| Germany | DE | 27,414 | 27,292 | 19,931 | 3.31% | `aggregated-de-only.txt` |
| South Korea | KR | 3,962 | 3,949 | 13,753 | 2.28% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 601,891 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,895 IPs from AU
- **`aggregated-ca-only.txt`** - 11,705 IPs from CA
- **`aggregated-de-only.txt`** - 19,931 IPs from DE
- **`aggregated-gb-only.txt`** - 10,076 IPs from GB
- **`aggregated-kr-only.txt`** - 13,753 IPs from KR
- **`aggregated-us-only.txt`** - 75,721 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 136,081 unique IPs (deduplicated across all countries)
