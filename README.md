...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-437257-2D56A8)
...
**Last Updated:** 2026-07-07 16:43:27 UTC
...
- **Total Input IPs:** 437,257
- **Countries Processed:** 6
- **Combined Unique IPs:** 141,613
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 146,470 | 144,657 | 80,160 | 18.33% | `aggregated-us-only.txt` |
| Canada | CA | 16,851 | 16,729 | 10,197 | 2.33% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,133 | 34,962 | 13,968 | 3.19% | `aggregated-gb-only.txt` |
| Australia | AU | 12,084 | 12,012 | 9,951 | 2.28% | `aggregated-au-only.txt` |
| Germany | DE | 29,016 | 28,930 | 21,032 | 4.81% | `aggregated-de-only.txt` |
| South Korea | KR | 3,913 | 3,903 | 6,305 | 1.44% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 437,257 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 9,951 IPs from AU
- **`aggregated-ca-only.txt`** - 10,197 IPs from CA
- **`aggregated-de-only.txt`** - 21,032 IPs from DE
- **`aggregated-gb-only.txt`** - 13,968 IPs from GB
- **`aggregated-kr-only.txt`** - 6,305 IPs from KR
- **`aggregated-us-only.txt`** - 80,160 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 141,613 unique IPs (deduplicated across all countries)
