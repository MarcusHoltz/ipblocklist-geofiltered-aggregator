...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-400534-2D56A8)
...
- **`aggregated.txt`** - 400,534 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 9,101 IPs from AU
- **`aggregated-ca-only.txt`** - 9,340 IPs from CA
- **`aggregated-de-only.txt`** - 17,850 IPs from DE
- **`aggregated-gb-only.txt`** - 11,945 IPs from GB
- **`aggregated-kr-only.txt`** - 6,550 IPs from KR
- **`aggregated-us-only.txt`** - 75,511 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 130,297 unique IPs (deduplicated across all countries)
