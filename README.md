...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-666049-2D56A8)
...
**Last Updated:** 2026-09-10 17:45:05 UTC
...
- **Total Input IPs:** 666,049
- **Countries Processed:** 6
- **Combined Unique IPs:** 192,671
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,282 | 128,440 | 138,038 | 20.72% | `aggregated-us-only.txt` |
| Canada | CA | 17,185 | 17,069 | 10,777 | 1.62% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,923 | 35,760 | 12,754 | 1.91% | `aggregated-gb-only.txt` |
| Australia | AU | 12,309 | 12,242 | 4,720 | 0.71% | `aggregated-au-only.txt` |
| Germany | DE | 29,980 | 29,865 | 18,639 | 2.80% | `aggregated-de-only.txt` |
| South Korea | KR | 3,943 | 3,932 | 7,743 | 1.16% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 666,049 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,720 IPs from AU
- **`aggregated-ca-only.txt`** - 10,777 IPs from CA
- **`aggregated-de-only.txt`** - 18,639 IPs from DE
- **`aggregated-gb-only.txt`** - 12,754 IPs from GB
- **`aggregated-kr-only.txt`** - 7,743 IPs from KR
- **`aggregated-us-only.txt`** - 138,038 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 192,671 unique IPs (deduplicated across all countries)
