...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-604099-2D56A8)
...
- **`aggregated.txt`** - 604,099 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,883 IPs from AU
- **`aggregated-ca-only.txt`** - 11,475 IPs from CA
- **`aggregated-de-only.txt`** - 19,719 IPs from DE
- **`aggregated-gb-only.txt`** - 10,053 IPs from GB
- **`aggregated-kr-only.txt`** - 13,647 IPs from KR
- **`aggregated-us-only.txt`** - 76,571 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 136,348 unique IPs (deduplicated across all countries)
