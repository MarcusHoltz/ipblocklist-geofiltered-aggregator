...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-506323-2D56A8)
...
- **`aggregated.txt`** - 506,323 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,240 IPs from AU
- **`aggregated-ca-only.txt`** - 10,370 IPs from CA
- **`aggregated-de-only.txt`** - 16,737 IPs from DE
- **`aggregated-gb-only.txt`** - 9,473 IPs from GB
- **`aggregated-kr-only.txt`** - 12,350 IPs from KR
- **`aggregated-us-only.txt`** - 70,147 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,317 unique IPs (deduplicated across all countries)
