...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-583478-2D56A8)
...
**Last Updated:** 2025-09-21 14:32:01 UTC
...
- **Total Input IPs:** 583,478
- **Countries Processed:** 6
- **Combined Unique IPs:** 137,481
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.56%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 224,791 | 222,401 | 76,629 | 13.13% | `aggregated-us-only.txt` |
| Canada | CA | 17,886 | 17,771 | 11,867 | 2.03% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,808 | 32,653 | 10,200 | 1.75% | `aggregated-gb-only.txt` |
| Australia | AU | 11,669 | 11,610 | 4,890 | 0.84% | `aggregated-au-only.txt` |
| Germany | DE | 27,582 | 27,471 | 20,321 | 3.48% | `aggregated-de-only.txt` |
| South Korea | KR | 4,009 | 4,008 | 13,574 | 2.33% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 583,478 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,890 IPs from AU
- **`aggregated-ca-only.txt`** - 11,867 IPs from CA
- **`aggregated-de-only.txt`** - 20,321 IPs from DE
- **`aggregated-gb-only.txt`** - 10,200 IPs from GB
- **`aggregated-kr-only.txt`** - 13,574 IPs from KR
- **`aggregated-us-only.txt`** - 76,629 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 137,481 unique IPs (deduplicated across all countries)
