...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-509571-2D56A8)
...
**Last Updated:** 2025-10-15 03:15:39 UTC
...
- **Total Input IPs:** 509,571
- **Countries Processed:** 6
- **Combined Unique IPs:** 122,932
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 24.12%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 227,690 | 225,148 | 69,586 | 13.66% | `aggregated-us-only.txt` |
| Canada | CA | 17,925 | 17,808 | 10,441 | 2.05% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,170 | 33,025 | 9,419 | 1.85% | `aggregated-gb-only.txt` |
| Australia | AU | 11,608 | 11,551 | 4,238 | 0.83% | `aggregated-au-only.txt` |
| Germany | DE | 27,833 | 27,710 | 16,888 | 3.31% | `aggregated-de-only.txt` |
| South Korea | KR | 4,022 | 4,021 | 12,360 | 2.43% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 509,571 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,238 IPs from AU
- **`aggregated-ca-only.txt`** - 10,441 IPs from CA
- **`aggregated-de-only.txt`** - 16,888 IPs from DE
- **`aggregated-gb-only.txt`** - 9,419 IPs from GB
- **`aggregated-kr-only.txt`** - 12,360 IPs from KR
- **`aggregated-us-only.txt`** - 69,586 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 122,932 unique IPs (deduplicated across all countries)
