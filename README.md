...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-430705-2D56A8)
...
**Last Updated:** 2026-06-22 07:44:47 UTC
...
- **Total Input IPs:** 430,705
- **Countries Processed:** 6
- **Combined Unique IPs:** 149,100
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 157,756 | 155,950 | 82,756 | 19.21% | `aggregated-us-only.txt` |
| Canada | CA | 17,019 | 16,891 | 10,904 | 2.53% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,639 | 35,460 | 15,665 | 3.64% | `aggregated-gb-only.txt` |
| Australia | AU | 12,040 | 11,957 | 10,998 | 2.55% | `aggregated-au-only.txt` |
| Germany | DE | 28,842 | 28,762 | 22,703 | 5.27% | `aggregated-de-only.txt` |
| South Korea | KR | 3,964 | 3,954 | 6,074 | 1.41% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 430,705 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,998 IPs from AU
- **`aggregated-ca-only.txt`** - 10,904 IPs from CA
- **`aggregated-de-only.txt`** - 22,703 IPs from DE
- **`aggregated-gb-only.txt`** - 15,665 IPs from GB
- **`aggregated-kr-only.txt`** - 6,074 IPs from KR
- **`aggregated-us-only.txt`** - 82,756 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 149,100 unique IPs (deduplicated across all countries)
