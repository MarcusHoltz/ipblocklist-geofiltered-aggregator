...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-416668-2D56A8)
...
- **`aggregated.txt`** - 416,668 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,579 IPs from AU
- **`aggregated-ca-only.txt`** - 9,100 IPs from CA
- **`aggregated-de-only.txt`** - 15,178 IPs from DE
- **`aggregated-gb-only.txt`** - 8,543 IPs from GB
- **`aggregated-kr-only.txt`** - 11,141 IPs from KR
- **`aggregated-us-only.txt`** - 68,537 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 117,078 unique IPs (deduplicated across all countries)
