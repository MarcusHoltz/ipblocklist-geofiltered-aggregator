...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-462688-2D56A8)
...
**Last Updated:** 2026-01-25 14:39:15 UTC
...
- **Total Input IPs:** 462,688
- **Countries Processed:** 6
- **Combined Unique IPs:** 138,177
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 191,318 | 189,710 | 81,778 | 17.67% | `aggregated-us-only.txt` |
| Canada | CA | 17,196 | 17,071 | 11,608 | 2.51% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,750 | 33,592 | 11,569 | 2.50% | `aggregated-gb-only.txt` |
| Australia | AU | 11,508 | 11,442 | 5,769 | 1.25% | `aggregated-au-only.txt` |
| Germany | DE | 27,570 | 27,449 | 18,865 | 4.08% | `aggregated-de-only.txt` |
| South Korea | KR | 3,997 | 3,983 | 8,588 | 1.86% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 462,688 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,769 IPs from AU
- **`aggregated-ca-only.txt`** - 11,608 IPs from CA
- **`aggregated-de-only.txt`** - 18,865 IPs from DE
- **`aggregated-gb-only.txt`** - 11,569 IPs from GB
- **`aggregated-kr-only.txt`** - 8,588 IPs from KR
- **`aggregated-us-only.txt`** - 81,778 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 138,177 unique IPs (deduplicated across all countries)
