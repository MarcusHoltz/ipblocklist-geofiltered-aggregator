...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-428291-2D56A8)
...
**Last Updated:** 2026-04-18 04:43:09 UTC
...
- **Total Input IPs:** 428,291
- **Countries Processed:** 6
- **Combined Unique IPs:** 135,022
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 174,297 | 172,744 | 74,494 | 17.39% | `aggregated-us-only.txt` |
| Canada | CA | 16,926 | 16,789 | 9,860 | 2.30% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,790 | 33,627 | 14,539 | 3.39% | `aggregated-gb-only.txt` |
| Australia | AU | 11,413 | 11,331 | 10,581 | 2.47% | `aggregated-au-only.txt` |
| Germany | DE | 28,732 | 28,618 | 19,544 | 4.56% | `aggregated-de-only.txt` |
| South Korea | KR | 4,047 | 4,037 | 6,004 | 1.40% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 428,291 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,581 IPs from AU
- **`aggregated-ca-only.txt`** - 9,860 IPs from CA
- **`aggregated-de-only.txt`** - 19,544 IPs from DE
- **`aggregated-gb-only.txt`** - 14,539 IPs from GB
- **`aggregated-kr-only.txt`** - 6,004 IPs from KR
- **`aggregated-us-only.txt`** - 74,494 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 135,022 unique IPs (deduplicated across all countries)
