...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-707912-2D56A8)
...
- **`aggregated.txt`** - 707,912 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,253 IPs from AU
- **`aggregated-ca-only.txt`** - 11,299 IPs from CA
- **`aggregated-de-only.txt`** - 21,304 IPs from DE
- **`aggregated-gb-only.txt`** - 13,710 IPs from GB
- **`aggregated-kr-only.txt`** - 10,337 IPs from KR
- **`aggregated-us-only.txt`** - 145,664 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 207,567 unique IPs (deduplicated across all countries)
