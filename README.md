...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-425932-2D56A8)
...
**Last Updated:** 2026-03-19 04:33:18 UTC
...
- **Total Input IPs:** 425,932
- **Countries Processed:** 6
- **Combined Unique IPs:** 138,727
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 182,037 | 180,421 | 77,956 | 18.30% | `aggregated-us-only.txt` |
| Canada | CA | 16,831 | 16,710 | 9,902 | 2.32% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,542 | 33,383 | 14,543 | 3.41% | `aggregated-gb-only.txt` |
| Australia | AU | 11,394 | 11,313 | 10,797 | 2.53% | `aggregated-au-only.txt` |
| Germany | DE | 28,759 | 28,678 | 18,993 | 4.46% | `aggregated-de-only.txt` |
| South Korea | KR | 4,059 | 4,048 | 6,536 | 1.53% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 425,932 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,797 IPs from AU
- **`aggregated-ca-only.txt`** - 9,902 IPs from CA
- **`aggregated-de-only.txt`** - 18,993 IPs from DE
- **`aggregated-gb-only.txt`** - 14,543 IPs from GB
- **`aggregated-kr-only.txt`** - 6,536 IPs from KR
- **`aggregated-us-only.txt`** - 77,956 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 138,727 unique IPs (deduplicated across all countries)
