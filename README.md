...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-439096-2D56A8)
...
**Last Updated:** 2026-06-16 18:41:52 UTC
...
- **Total Input IPs:** 439,096
- **Countries Processed:** 6
- **Combined Unique IPs:** 154,107
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 35.10%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 162,102 | 160,287 | 83,597 | 19.04% | `aggregated-us-only.txt` |
| Canada | CA | 16,986 | 16,858 | 12,785 | 2.91% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,600 | 35,425 | 16,680 | 3.80% | `aggregated-gb-only.txt` |
| Australia | AU | 12,043 | 11,960 | 11,116 | 2.53% | `aggregated-au-only.txt` |
| Germany | DE | 28,808 | 28,728 | 24,024 | 5.47% | `aggregated-de-only.txt` |
| South Korea | KR | 3,954 | 3,944 | 5,905 | 1.34% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 439,096 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 11,116 IPs from AU
- **`aggregated-ca-only.txt`** - 12,785 IPs from CA
- **`aggregated-de-only.txt`** - 24,024 IPs from DE
- **`aggregated-gb-only.txt`** - 16,680 IPs from GB
- **`aggregated-kr-only.txt`** - 5,905 IPs from KR
- **`aggregated-us-only.txt`** - 83,597 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 154,107 unique IPs (deduplicated across all countries)
