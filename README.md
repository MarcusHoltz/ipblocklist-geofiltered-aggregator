...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-465129-2D56A8)
...
**Last Updated:** 2026-08-20 14:59:14 UTC
...
- **Total Input IPs:** 465,129
- **Countries Processed:** 6
- **Combined Unique IPs:** 130,212
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 131,721 | 129,853 | 88,316 | 18.99% | `aggregated-us-only.txt` |
| Canada | CA | 17,158 | 17,035 | 7,757 | 1.67% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,713 | 35,551 | 8,995 | 1.93% | `aggregated-gb-only.txt` |
| Australia | AU | 12,195 | 12,123 | 3,621 | 0.78% | `aggregated-au-only.txt` |
| Germany | DE | 29,761 | 29,693 | 15,208 | 3.27% | `aggregated-de-only.txt` |
| South Korea | KR | 3,928 | 3,918 | 6,315 | 1.36% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 465,129 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,621 IPs from AU
- **`aggregated-ca-only.txt`** - 7,757 IPs from CA
- **`aggregated-de-only.txt`** - 15,208 IPs from DE
- **`aggregated-gb-only.txt`** - 8,995 IPs from GB
- **`aggregated-kr-only.txt`** - 6,315 IPs from KR
- **`aggregated-us-only.txt`** - 88,316 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 130,212 unique IPs (deduplicated across all countries)
