...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-523070-2D56A8)
...
**Last Updated:** 2025-10-08 03:08:52 UTC
...
- **Total Input IPs:** 523,070
- **Countries Processed:** 6
- **Combined Unique IPs:** 123,074
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.53%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 226,331 | 223,775 | 69,345 | 13.26% | `aggregated-us-only.txt` |
| Canada | CA | 17,971 | 17,851 | 10,529 | 2.01% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,071 | 32,917 | 9,335 | 1.78% | `aggregated-gb-only.txt` |
| Australia | AU | 11,560 | 11,500 | 4,197 | 0.80% | `aggregated-au-only.txt` |
| Germany | DE | 27,643 | 27,520 | 16,925 | 3.24% | `aggregated-de-only.txt` |
| South Korea | KR | 4,001 | 4,000 | 12,743 | 2.44% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 523,070 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,197 IPs from AU
- **`aggregated-ca-only.txt`** - 10,529 IPs from CA
- **`aggregated-de-only.txt`** - 16,925 IPs from DE
- **`aggregated-gb-only.txt`** - 9,335 IPs from GB
- **`aggregated-kr-only.txt`** - 12,743 IPs from KR
- **`aggregated-us-only.txt`** - 69,345 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,074 unique IPs (deduplicated across all countries)
