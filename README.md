...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-453701-2D56A8)
...
- **`aggregated.txt`** - 453,701 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,246 IPs from AU
- **`aggregated-ca-only.txt`** - 8,027 IPs from CA
- **`aggregated-de-only.txt`** - 17,401 IPs from DE
- **`aggregated-gb-only.txt`** - 8,920 IPs from GB
- **`aggregated-kr-only.txt`** - 6,227 IPs from KR
- **`aggregated-us-only.txt`** - 81,512 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 127,333 unique IPs (deduplicated across all countries)
