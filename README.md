...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-380157-2D56A8)
...
- **`aggregated.txt`** - 380,157 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,383 IPs from AU
- **`aggregated-ca-only.txt`** - 8,731 IPs from CA
- **`aggregated-de-only.txt`** - 14,842 IPs from DE
- **`aggregated-gb-only.txt`** - 8,819 IPs from GB
- **`aggregated-kr-only.txt`** - 7,673 IPs from KR
- **`aggregated-us-only.txt`** - 72,669 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 118,117 unique IPs (deduplicated across all countries)
