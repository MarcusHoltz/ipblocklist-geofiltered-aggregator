...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-491184-2D56A8)
...
**Last Updated:** 2026-01-19 04:00:29 UTC
...
- **Total Input IPs:** 491,184
- **Countries Processed:** 6
- **Combined Unique IPs:** 141,386
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 192,503 | 190,855 | 85,075 | 17.32% | `aggregated-us-only.txt` |
| Canada | CA | 17,317 | 17,192 | 10,939 | 2.23% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,656 | 33,494 | 11,762 | 2.39% | `aggregated-gb-only.txt` |
| Australia | AU | 11,536 | 11,469 | 5,836 | 1.19% | `aggregated-au-only.txt` |
| Germany | DE | 27,599 | 27,451 | 19,002 | 3.87% | `aggregated-de-only.txt` |
| South Korea | KR | 3,999 | 3,985 | 8,772 | 1.79% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 491,184 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,836 IPs from AU
- **`aggregated-ca-only.txt`** - 10,939 IPs from CA
- **`aggregated-de-only.txt`** - 19,002 IPs from DE
- **`aggregated-gb-only.txt`** - 11,762 IPs from GB
- **`aggregated-kr-only.txt`** - 8,772 IPs from KR
- **`aggregated-us-only.txt`** - 85,075 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 141,386 unique IPs (deduplicated across all countries)
