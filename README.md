...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-603952-2D56A8)
...
- **`aggregated.txt`** - 603,952 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,583 IPs from AU
- **`aggregated-ca-only.txt`** - 10,610 IPs from CA
- **`aggregated-de-only.txt`** - 19,065 IPs from DE
- **`aggregated-gb-only.txt`** - 9,756 IPs from GB
- **`aggregated-kr-only.txt`** - 13,207 IPs from KR
- **`aggregated-us-only.txt`** - 73,760 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 130,981 unique IPs (deduplicated across all countries)
