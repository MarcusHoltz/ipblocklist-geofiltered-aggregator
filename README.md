...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-447019-2D56A8)
...
**Last Updated:** 2026-07-29 05:33:54 UTC
...
- **Total Input IPs:** 447,019
- **Countries Processed:** 6
- **Combined Unique IPs:** 128,227
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 135,484 | 133,670 | 79,262 | 17.73% | `aggregated-us-only.txt` |
| Canada | CA | 16,948 | 16,824 | 8,057 | 1.80% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,497 | 35,342 | 9,473 | 2.12% | `aggregated-gb-only.txt` |
| Australia | AU | 12,139 | 12,065 | 5,824 | 1.30% | `aggregated-au-only.txt` |
| Germany | DE | 29,225 | 29,158 | 19,282 | 4.31% | `aggregated-de-only.txt` |
| South Korea | KR | 3,949 | 3,939 | 6,329 | 1.42% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 447,019 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,824 IPs from AU
- **`aggregated-ca-only.txt`** - 8,057 IPs from CA
- **`aggregated-de-only.txt`** - 19,282 IPs from DE
- **`aggregated-gb-only.txt`** - 9,473 IPs from GB
- **`aggregated-kr-only.txt`** - 6,329 IPs from KR
- **`aggregated-us-only.txt`** - 79,262 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 128,227 unique IPs (deduplicated across all countries)
