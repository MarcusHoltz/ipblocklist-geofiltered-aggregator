...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-433505-2D56A8)
...
**Last Updated:** 2026-03-28 14:54:26 UTC
...
- **Total Input IPs:** 433,505
- **Countries Processed:** 6
- **Combined Unique IPs:** 136,284
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 181,809 | 180,208 | 75,705 | 17.46% | `aggregated-us-only.txt` |
| Canada | CA | 16,866 | 16,741 | 9,469 | 2.18% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,693 | 33,508 | 14,813 | 3.42% | `aggregated-gb-only.txt` |
| Australia | AU | 11,441 | 11,360 | 10,556 | 2.44% | `aggregated-au-only.txt` |
| Germany | DE | 28,381 | 28,291 | 19,212 | 4.43% | `aggregated-de-only.txt` |
| South Korea | KR | 4,031 | 4,020 | 6,529 | 1.51% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 433,505 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,556 IPs from AU
- **`aggregated-ca-only.txt`** - 9,469 IPs from CA
- **`aggregated-de-only.txt`** - 19,212 IPs from DE
- **`aggregated-gb-only.txt`** - 14,813 IPs from GB
- **`aggregated-kr-only.txt`** - 6,529 IPs from KR
- **`aggregated-us-only.txt`** - 75,705 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 136,284 unique IPs (deduplicated across all countries)
