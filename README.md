...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-399713-2D56A8)
...
**Last Updated:** 2025-12-02 03:37:51 UTC
...
- **Total Input IPs:** 399,713
- **Countries Processed:** 6
- **Combined Unique IPs:** 119,249
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 29.83%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 208,627 | 207,128 | 70,741 | 17.70% | `aggregated-us-only.txt` |
| Canada | CA | 17,397 | 17,271 | 8,465 | 2.12% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,084 | 32,951 | 8,645 | 2.16% | `aggregated-gb-only.txt` |
| Australia | AU | 11,257 | 11,196 | 5,298 | 1.33% | `aggregated-au-only.txt` |
| Germany | DE | 27,412 | 27,288 | 14,979 | 3.75% | `aggregated-de-only.txt` |
| South Korea | KR | 4,016 | 4,015 | 11,121 | 2.78% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 399,713 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,298 IPs from AU
- **`aggregated-ca-only.txt`** - 8,465 IPs from CA
- **`aggregated-de-only.txt`** - 14,979 IPs from DE
- **`aggregated-gb-only.txt`** - 8,645 IPs from GB
- **`aggregated-kr-only.txt`** - 11,121 IPs from KR
- **`aggregated-us-only.txt`** - 70,741 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 119,249 unique IPs (deduplicated across all countries)
