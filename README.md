...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-386576-2D56A8)
...
**Last Updated:** 2026-02-14 14:48:59 UTC
...
- **Total Input IPs:** 386,576
- **Countries Processed:** 6
- **Combined Unique IPs:** 119,530
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 30.92%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 187,914 | 186,301 | 74,067 | 19.16% | `aggregated-us-only.txt` |
| Canada | CA | 16,725 | 16,598 | 8,098 | 2.09% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,454 | 33,292 | 9,120 | 2.36% | `aggregated-gb-only.txt` |
| Australia | AU | 11,406 | 11,340 | 5,433 | 1.41% | `aggregated-au-only.txt` |
| Germany | DE | 27,868 | 27,751 | 15,113 | 3.91% | `aggregated-de-only.txt` |
| South Korea | KR | 4,014 | 4,000 | 7,699 | 1.99% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 386,576 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,433 IPs from AU
- **`aggregated-ca-only.txt`** - 8,098 IPs from CA
- **`aggregated-de-only.txt`** - 15,113 IPs from DE
- **`aggregated-gb-only.txt`** - 9,120 IPs from GB
- **`aggregated-kr-only.txt`** - 7,699 IPs from KR
- **`aggregated-us-only.txt`** - 74,067 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 119,530 unique IPs (deduplicated across all countries)
