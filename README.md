...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-429317-2D56A8)
...
**Last Updated:** 2025-12-21 14:36:18 UTC
...
- **Total Input IPs:** 429,317
- **Countries Processed:** 6
- **Combined Unique IPs:** 126,178
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 201,619 | 200,020 | 75,267 | 17.53% | `aggregated-us-only.txt` |
| Canada | CA | 17,339 | 17,213 | 8,510 | 1.98% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,812 | 33,657 | 9,833 | 2.29% | `aggregated-gb-only.txt` |
| Australia | AU | 11,538 | 11,468 | 5,746 | 1.34% | `aggregated-au-only.txt` |
| Germany | DE | 27,526 | 27,387 | 16,127 | 3.76% | `aggregated-de-only.txt` |
| South Korea | KR | 4,005 | 4,004 | 10,695 | 2.49% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 429,317 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,746 IPs from AU
- **`aggregated-ca-only.txt`** - 8,510 IPs from CA
- **`aggregated-de-only.txt`** - 16,127 IPs from DE
- **`aggregated-gb-only.txt`** - 9,833 IPs from GB
- **`aggregated-kr-only.txt`** - 10,695 IPs from KR
- **`aggregated-us-only.txt`** - 75,267 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 126,178 unique IPs (deduplicated across all countries)
