...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-444422-2D56A8)
...
**Last Updated:** 2026-05-14 05:59:08 UTC
...
- **Total Input IPs:** 444,422
- **Countries Processed:** 6
- **Combined Unique IPs:** 146,718
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,975 | 166,467 | 80,234 | 18.05% | `aggregated-us-only.txt` |
| Canada | CA | 17,039 | 16,905 | 10,939 | 2.46% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 34,028 | 33,858 | 16,321 | 3.67% | `aggregated-gb-only.txt` |
| Australia | AU | 12,110 | 12,041 | 10,899 | 2.45% | `aggregated-au-only.txt` |
| Germany | DE | 28,807 | 28,725 | 21,828 | 4.91% | `aggregated-de-only.txt` |
| South Korea | KR | 3,984 | 3,974 | 6,497 | 1.46% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 444,422 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,899 IPs from AU
- **`aggregated-ca-only.txt`** - 10,939 IPs from CA
- **`aggregated-de-only.txt`** - 21,828 IPs from DE
- **`aggregated-gb-only.txt`** - 16,321 IPs from GB
- **`aggregated-kr-only.txt`** - 6,497 IPs from KR
- **`aggregated-us-only.txt`** - 80,234 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 146,718 unique IPs (deduplicated across all countries)
