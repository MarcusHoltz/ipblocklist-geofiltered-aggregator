...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-452571-2D56A8)
...
**Last Updated:** 2026-05-19 06:30:36 UTC
...
- **Total Input IPs:** 452,571
- **Countries Processed:** 6
- **Combined Unique IPs:** 151,064
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,217 | 165,713 | 82,735 | 18.28% | `aggregated-us-only.txt` |
| Canada | CA | 17,079 | 16,951 | 11,268 | 2.49% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,930 | 33,764 | 16,736 | 3.70% | `aggregated-gb-only.txt` |
| Australia | AU | 12,099 | 12,029 | 11,185 | 2.47% | `aggregated-au-only.txt` |
| Germany | DE | 28,842 | 28,762 | 22,512 | 4.97% | `aggregated-de-only.txt` |
| South Korea | KR | 3,976 | 3,966 | 6,628 | 1.46% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 452,571 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 11,185 IPs from AU
- **`aggregated-ca-only.txt`** - 11,268 IPs from CA
- **`aggregated-de-only.txt`** - 22,512 IPs from DE
- **`aggregated-gb-only.txt`** - 16,736 IPs from GB
- **`aggregated-kr-only.txt`** - 6,628 IPs from KR
- **`aggregated-us-only.txt`** - 82,735 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 151,064 unique IPs (deduplicated across all countries)
