...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-581492-2D56A8)
...
**Last Updated:** 2025-09-21 03:16:42 UTC
...
- **Total Input IPs:** 581,492
- **Countries Processed:** 6
- **Combined Unique IPs:** 136,636
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.50%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 224,791 | 222,401 | 76,221 | 13.11% | `aggregated-us-only.txt` |
| Canada | CA | 17,886 | 17,771 | 11,801 | 2.03% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,808 | 32,653 | 10,093 | 1.74% | `aggregated-gb-only.txt` |
| Australia | AU | 11,669 | 11,610 | 4,875 | 0.84% | `aggregated-au-only.txt` |
| Germany | DE | 27,582 | 27,471 | 20,117 | 3.46% | `aggregated-de-only.txt` |
| South Korea | KR | 4,009 | 4,008 | 13,529 | 2.33% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 581,492 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,875 IPs from AU
- **`aggregated-ca-only.txt`** - 11,801 IPs from CA
- **`aggregated-de-only.txt`** - 20,117 IPs from DE
- **`aggregated-gb-only.txt`** - 10,093 IPs from GB
- **`aggregated-kr-only.txt`** - 13,529 IPs from KR
- **`aggregated-us-only.txt`** - 76,221 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 136,636 unique IPs (deduplicated across all countries)
