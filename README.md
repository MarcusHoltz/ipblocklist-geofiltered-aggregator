...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-382704-2D56A8)
...
**Last Updated:** 2026-02-11 15:17:05 UTC
...
- **Total Input IPs:** 382,704
- **Countries Processed:** 6
- **Combined Unique IPs:** 118,845
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 187,914 | 186,301 | 73,006 | 19.08% | `aggregated-us-only.txt` |
| Canada | CA | 16,725 | 16,598 | 9,077 | 2.37% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,454 | 33,292 | 8,615 | 2.25% | `aggregated-gb-only.txt` |
| Australia | AU | 11,406 | 11,340 | 5,419 | 1.42% | `aggregated-au-only.txt` |
| Germany | DE | 27,868 | 27,751 | 15,021 | 3.92% | `aggregated-de-only.txt` |
| South Korea | KR | 4,014 | 4,000 | 7,707 | 2.01% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 382,704 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,419 IPs from AU
- **`aggregated-ca-only.txt`** - 9,077 IPs from CA
- **`aggregated-de-only.txt`** - 15,021 IPs from DE
- **`aggregated-gb-only.txt`** - 8,615 IPs from GB
- **`aggregated-kr-only.txt`** - 7,707 IPs from KR
- **`aggregated-us-only.txt`** - 73,006 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 118,845 unique IPs (deduplicated across all countries)
