...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-462716-2D56A8)
...
**Last Updated:** 2025-11-02 03:32:15 UTC
...
- **Total Input IPs:** 462,716
- **Countries Processed:** 6
- **Combined Unique IPs:** 120,450
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 26.03%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 231,913 | 228,631 | 69,328 | 14.98% | `aggregated-us-only.txt` |
| Canada | CA | 18,016 | 17,895 | 9,936 | 2.15% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,513 | 33,361 | 9,095 | 1.97% | `aggregated-gb-only.txt` |
| Australia | AU | 11,668 | 11,599 | 3,946 | 0.85% | `aggregated-au-only.txt` |
| Germany | DE | 28,153 | 28,044 | 16,133 | 3.49% | `aggregated-de-only.txt` |
| South Korea | KR | 4,075 | 4,074 | 12,012 | 2.60% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 462,716 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,946 IPs from AU
- **`aggregated-ca-only.txt`** - 9,936 IPs from CA
- **`aggregated-de-only.txt`** - 16,133 IPs from DE
- **`aggregated-gb-only.txt`** - 9,095 IPs from GB
- **`aggregated-kr-only.txt`** - 12,012 IPs from KR
- **`aggregated-us-only.txt`** - 69,328 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 120,450 unique IPs (deduplicated across all countries)
