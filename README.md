...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-524549-2D56A8)
...
**Last Updated:** 2025-10-09 03:11:17 UTC
...
- **Total Input IPs:** 524,549
- **Countries Processed:** 6
- **Combined Unique IPs:** 123,519
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 23.55%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 226,331 | 223,775 | 69,662 | 13.28% | `aggregated-us-only.txt` |
| Canada | CA | 17,971 | 17,851 | 10,562 | 2.01% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,071 | 32,917 | 9,355 | 1.78% | `aggregated-gb-only.txt` |
| Australia | AU | 11,560 | 11,500 | 4,251 | 0.81% | `aggregated-au-only.txt` |
| Germany | DE | 27,643 | 27,520 | 16,935 | 3.23% | `aggregated-de-only.txt` |
| South Korea | KR | 4,001 | 4,000 | 12,754 | 2.43% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 524,549 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,251 IPs from AU
- **`aggregated-ca-only.txt`** - 10,562 IPs from CA
- **`aggregated-de-only.txt`** - 16,935 IPs from DE
- **`aggregated-gb-only.txt`** - 9,355 IPs from GB
- **`aggregated-kr-only.txt`** - 12,754 IPs from KR
- **`aggregated-us-only.txt`** - 69,662 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 123,519 unique IPs (deduplicated across all countries)
