...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-415911-2D56A8)
...
**Last Updated:** 2025-11-17 03:34:53 UTC
...
- **Total Input IPs:** 415,911
- **Countries Processed:** 6
- **Combined Unique IPs:** 116,936
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 28.12%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 213,082 | 211,660 | 68,467 | 16.46% | `aggregated-us-only.txt` |
| Canada | CA | 17,510 | 17,389 | 9,045 | 2.17% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,226 | 33,096 | 8,487 | 2.04% | `aggregated-gb-only.txt` |
| Australia | AU | 11,247 | 11,177 | 4,632 | 1.11% | `aggregated-au-only.txt` |
| Germany | DE | 27,310 | 27,183 | 15,167 | 3.65% | `aggregated-de-only.txt` |
| South Korea | KR | 4,040 | 4,039 | 11,138 | 2.68% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 415,911 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,632 IPs from AU
- **`aggregated-ca-only.txt`** - 9,045 IPs from CA
- **`aggregated-de-only.txt`** - 15,167 IPs from DE
- **`aggregated-gb-only.txt`** - 8,487 IPs from GB
- **`aggregated-kr-only.txt`** - 11,138 IPs from KR
- **`aggregated-us-only.txt`** - 68,467 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 116,936 unique IPs (deduplicated across all countries)
