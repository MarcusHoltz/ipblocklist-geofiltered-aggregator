...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-464396-2D56A8)
...
**Last Updated:** 2026-08-27 12:53:30 UTC
...
- **Total Input IPs:** 464,396
- **Countries Processed:** 6
- **Combined Unique IPs:** 132,825
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 131,379 | 129,526 | 91,425 | 19.69% | `aggregated-us-only.txt` |
| Canada | CA | 17,186 | 17,068 | 8,389 | 1.81% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 35,817 | 35,660 | 8,729 | 1.88% | `aggregated-gb-only.txt` |
| Australia | AU | 12,214 | 12,142 | 3,562 | 0.77% | `aggregated-au-only.txt` |
| Germany | DE | 29,887 | 29,783 | 14,578 | 3.14% | `aggregated-de-only.txt` |
| South Korea | KR | 3,914 | 3,903 | 6,142 | 1.32% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 464,396 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 3,562 IPs from AU
- **`aggregated-ca-only.txt`** - 8,389 IPs from CA
- **`aggregated-de-only.txt`** - 14,578 IPs from DE
- **`aggregated-gb-only.txt`** - 8,729 IPs from GB
- **`aggregated-kr-only.txt`** - 6,142 IPs from KR
- **`aggregated-us-only.txt`** - 91,425 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 132,825 unique IPs (deduplicated across all countries)
