...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-428416-2D56A8)
...
**Last Updated:** 2026-03-20 15:12:53 UTC
...
- **Total Input IPs:** 428,416
- **Countries Processed:** 6
- **Combined Unique IPs:** 139,283
- **Combined Output File:** `aggregated-multi-6countries-combined.txt`
- **Overall Filter Rate:** 32.51%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 182,037 | 180,421 | 78,394 | 18.30% | `aggregated-us-only.txt` |
| Canada | CA | 16,831 | 16,710 | 9,522 | 2.22% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,542 | 33,383 | 14,649 | 3.42% | `aggregated-gb-only.txt` |
| Australia | AU | 11,394 | 11,313 | 10,873 | 2.54% | `aggregated-au-only.txt` |
| Germany | DE | 28,759 | 28,678 | 19,254 | 4.49% | `aggregated-de-only.txt` |
| South Korea | KR | 4,059 | 4,048 | 6,591 | 1.54% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 428,416 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 10,873 IPs from AU
- **`aggregated-ca-only.txt`** - 9,522 IPs from CA
- **`aggregated-de-only.txt`** - 19,254 IPs from DE
- **`aggregated-gb-only.txt`** - 14,649 IPs from GB
- **`aggregated-kr-only.txt`** - 6,591 IPs from KR
- **`aggregated-us-only.txt`** - 78,394 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 139,283 unique IPs (deduplicated across all countries)
