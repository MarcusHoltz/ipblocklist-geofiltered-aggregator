...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-553861-2D56A8)
...
**Last Updated:** 2025-10-01 03:19:57 UTC
...
- **Total Input IPs:** 553,861
- **Countries Processed:** 6
- **Combined Unique IPs:** 129,874
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 225,472 | 222,928 | 73,486 | 13.27% | `aggregated-us-only.txt` |
| Canada | CA | 17,937 | 17,822 | 11,129 | 2.01% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 32,943 | 32,788 | 9,419 | 1.70% | `aggregated-gb-only.txt` |
| Australia | AU | 11,681 | 11,621 | 4,716 | 0.85% | `aggregated-au-only.txt` |
| Germany | DE | 27,612 | 27,495 | 17,993 | 3.25% | `aggregated-de-only.txt` |
| South Korea | KR | 4,005 | 4,004 | 13,131 | 2.37% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 553,861 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 4,716 IPs from AU
- **`aggregated-ca-only.txt`** - 11,129 IPs from CA
- **`aggregated-de-only.txt`** - 17,993 IPs from DE
- **`aggregated-gb-only.txt`** - 9,419 IPs from GB
- **`aggregated-kr-only.txt`** - 13,131 IPs from KR
- **`aggregated-us-only.txt`** - 73,486 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 129,874 unique IPs (deduplicated across all countries)
