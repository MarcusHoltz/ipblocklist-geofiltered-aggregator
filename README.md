...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-412850-2D56A8)
...
**Last Updated:** 2025-12-18 03:41:06 UTC
...
- **Total Input IPs:** 412,850
- **Countries Processed:** 6
- **Combined Unique IPs:** 124,599
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 205,029 | 203,447 | 74,334 | 18.01% | `aggregated-us-only.txt` |
| Canada | CA | 17,534 | 17,408 | 8,456 | 2.05% | `aggregated-ca-only.txt` |
| United Kingdom | GB | 33,613 | 33,458 | 9,653 | 2.34% | `aggregated-gb-only.txt` |
| Australia | AU | 11,630 | 11,560 | 5,592 | 1.35% | `aggregated-au-only.txt` |
| Germany | DE | 27,435 | 27,295 | 15,897 | 3.85% | `aggregated-de-only.txt` |
| South Korea | KR | 3,986 | 3,985 | 10,667 | 2.58% | `aggregated-kr-only.txt` |
...
- **`aggregated.txt`** - 412,850 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,592 IPs from AU
- **`aggregated-ca-only.txt`** - 8,456 IPs from CA
- **`aggregated-de-only.txt`** - 15,897 IPs from DE
- **`aggregated-gb-only.txt`** - 9,653 IPs from GB
- **`aggregated-kr-only.txt`** - 10,667 IPs from KR
- **`aggregated-us-only.txt`** - 74,334 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 124,599 unique IPs (deduplicated across all countries)
