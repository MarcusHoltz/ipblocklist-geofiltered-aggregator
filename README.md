...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-462383-2D56A8)
...
- **`aggregated.txt`** - 462,383 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 5,782 IPs from AU
- **`aggregated-ca-only.txt`** - 11,661 IPs from CA
- **`aggregated-de-only.txt`** - 18,878 IPs from DE
- **`aggregated-gb-only.txt`** - 11,602 IPs from GB
- **`aggregated-kr-only.txt`** - 8,568 IPs from KR
- **`aggregated-us-only.txt`** - 81,903 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 138,394 unique IPs (deduplicated across all countries)
